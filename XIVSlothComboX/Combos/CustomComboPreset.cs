...
namespace XIVSlothComboX.Combos
{
    ...
    public enum CustomComboPreset
    {
        ...
        [ReplaceSkill(All.Sprint)] [CustomComboInfo("无人岛冲刺", "将冲刺替换为无人岛冲刺.\n仅在无人岛使用.\n图标不会更改.\n不要和SimpleTweaks的[海岛冲刺替换]一起使用.", ADV.JobID)]
        ...
        [ReplaceSkill(All.Reprisal)] [ParentCombo(ALL_Tank_Menu)] [CustomComboInfo("防护：血仇防顶", "当目标已被赋予雪仇效果时，将雪仇替换为飞石", ADV.JobID)]
        ...
        [ReplaceSkill(All.Addle)] [ParentCombo(ALL_Caster_Menu)] [CustomComboInfo("远程魔法进攻: 昏乱防顶", "当目标已被赋予昏乱效果时，将昏乱替换为裂石飞环", ADV.JobID)]
        ...
        [ReplaceSkill(All.Feint)] [ParentCombo(ALL_Melee_Menu)] [CustomComboInfo("近战进攻：牵制防顶", "当目标已被赋予牵制效果时，将牵制替换为火炎", ADV.JobID)]
        ALL_Melee_Feint = 100030,

        [ReplaceSkill(All.TrueNorth)] [ParentCombo(ALL_Melee_Menu)] [CustomComboInfo("近战：真北保护", "当自身拥有真北时，将真北替换为火炎", ADV.JobID)]
        ...
        [ReplaceSkill(All.FootGraze)] [ParentCombo(ALL_Ranged_Menu)] [CustomComboInfo("物理远程进攻：打断选项", "当目标可被打断时，使用伤头代替伤足", ADV.JobID)]
        ...
        [ParentCombo(AST_ST_DPS)] [CustomComboInfo("光速选项", "循环加入光速", AST.JobID, 2, "", "")]
        AST_DPS_LightSpeed = 1020,

        [ParentCombo(AST_ST_DPS)] [CustomComboInfo("醒梦选项", "当 MP 低于滑动条的值时在循环中加入醒梦", AST.JobID, 3, "", "")]
        AST_DPS_Lucid = 1008,

        [ParentCombo(AST_ST_DPS)] [CustomComboInfo("占卜选项", "循环加入占卜", AST.JobID, 4, "", "")]
        ...
        [ReplaceSkill(AST.Benefic2)] [CustomComboInfo("简易治疗（单目标）", "", AST.JobID, 2)]
        AST_ST_SimpleHeals = 1023,

        [ParentCombo(AST_ST_SimpleHeals)] [CustomComboInfo("Essential Dignity Option", "当目标体力低于你设定的值时，自动添加先天禀赋进入单体治疗连击", AST.JobID)]
        AST_ST_SimpleHeals_EssentialDignity = 1024,

        [ParentCombo(AST_ST_SimpleHeals)] [CustomComboInfo("Celestial Intersection Option", "添加天星交错进入单体治疗连击", AST.JobID)]
        AST_ST_SimpleHeals_CelestialIntersection = 1025,

        [ParentCombo(AST_ST_SimpleHeals)] [CustomComboInfo("Aspected Benefic Option", "在目标身上没有吉星相位或快要结束时，自动更换福星为吉星相位", AST.JobID)]
        AST_ST_SimpleHeals_AspectedBenefic = 1027,

        [ParentCombo(AST_ST_SimpleHeals)] [CustomComboInfo("康复 选项", "当你的目标有一个可清除的debuff时则使用 康复。", AST.JobID)]
        AST_ST_SimpleHeals_Esuna = 1039,

        [ParentCombo(AST_ST_SimpleHeals)] [CustomComboInfo("擢升设置", "添加擢升进入治疗连击", AST.JobID)]
        AST_ST_SimpleHeals_Exaltation = 1028,

        [ReplaceSkill(AST.AspectedHelios)] [CustomComboInfo("阳星相位", "当你处于阳星相位hot时，用阳星来替换阳星相位", AST.JobID, 3, "", "")]
        AST_AoE_SimpleHeals_AspectedHelios = 1010,

        [ParentCombo(AST_AoE_SimpleHeals_AspectedHelios)] [CustomComboInfo("Celestial Opposition Option", "添加天星冲日进入AOE治疗连击", AST.JobID)]
        ...
        [ParentCombo(AST_AoE_SimpleHeals_AspectedHelios)] [CustomComboInfo("Horoscope Option", "添加天宫图进入治疗连击", AST.JobID)]
        ...
        [Variant] [VariantParent(AST_ST_DPS)] [CustomComboInfo("铁壁 选项", "冷却结束时使用多变铁壁", AST.JobID)]
        ...
        [ParentCombo(AST_Cards_QuickTargetCards)] [CustomComboInfo("将坦克和奶妈加入自动发牌目标选择", "如果没有 DPS 可选时选择坦克和奶妈", AST.JobID)]
        ...
        [CustomComboInfo("Thundercloud Spender Option", "Spends Thundercloud as soon as possible rather than waiting until Thunder is expiring.",
            BLM.JobID)]
        ...
        [ParentCombo(BLM_ST_AdvancedMode)] [CustomComboInfo("Movement Options", "Choose options to be used during movement.", BLM.JobID)]
        ...
        [ParentCombo(BLM_Adv_Casts)] [CustomComboInfo("Pool Triplecast Option", "Keep one Triplecast charge for movement.", BLM.JobID)]
        ...
        [ParentCombo(BLM_ST_SimpleMode)] [CustomComboInfo("雷云功能", "当自身存在雷云状态且目标身上没有dot存在或dot即将结束时，自动插入闪雷/暴雷.", BLM.JobID, 0, "", "")]
        BLM_Thunder = 2006,

        [ReplaceSkill(BLM.Flare)] [CustomComboInfo("简易 AoE 功能", "将核爆整合为一键AoE循环。", BLM.JobID, -1, "", "")]
        ...
        [ParentCombo(BLM_AoE_AdvancedMode)] [CustomComboInfo("Foul Option", "Adds Foul when available during Astral Fire.", BLM.JobID, 2, "", "")]
        ...
        [ParentCombo(BLM_AoE_SimpleMode)] [CustomComboInfo("秽浊/魔泉 核爆 功能", "当自身处于星极火状态且秽浊可用时插入秽浊，在秽浊后插入魔泉以便再使用一次核爆。", BLM.JobID, 0, "", "")]
        ...
        [Variant] [VariantParent(BLM_ST_SimpleMode, BLM_AoE_SimpleMode)] [CustomComboInfo("铁壁 选项", "冷却结束时使用多变铁壁", BLM.JobID)]
        BLM_Variant_Rampart = 2032,

        [Variant] [CustomComboInfo("复活 选项", "当你有即刻BUFF时，替换即刻为成多变复活", BLM.JobID)]
        BLM_Variant_Raise = 2033,

        [Variant] [VariantParent(BLM_ST_SimpleMode, BLM_AoE_SimpleMode)] [CustomComboInfo("治疗 选项", "在下水道使用治疗当HP低于某个值", BLM.JobID)]
        ...
        [ReplaceSkill(BLM.Transpose)] [CustomComboInfo("灵极魂/星灵移位功能", "当灵极魂可用时将星灵移位替换为灵极魂。", BLM.JobID, 0, "", "")]
        BLM_UmbralSoul = 2001,

        [ReplaceSkill(BLM.LeyLines)] [CustomComboInfo("魔纹步功能", "使用黑魔纹后将其替换为魔纹步。", BLM.JobID, 0, "", "")]
        BLM_Between_The_LeyLines = 2002,

        [ReplaceSkill(BLM.Blizzard, BLM.Freeze)] [CustomComboInfo("冰1/2/3", "当自身没有灵极冰状态时替换冰结为冰封，根据自身等级自动替换玄冰为冰冻。", BLM.JobID, 0, "", "")]
        ...
        [ReplaceSkill(BLM.Fire)] [CustomComboInfo("火炎/爆炎功能", "当自身没有星极火状态或使用火起手时，用爆炎替换火炎。", BLM.JobID, 0, "", "")]
        BLM_Fire_1to3 = 2005,
        ...
        [BlueInactive(BLU.Whistle, BLU.Tingle, BLU.MoonFlute, BLU.JKick, BLU.TripleTrident, BLU.Nightbloom, BLU.RoseOfDestruction, BLU.FeatherRain,
        ...
        [BlueInactive(BLU.MagicHammer)] [ReplaceSkill(BLU.MagicHammer)] [CustomComboInfo("昏乱/魔法锤Debuff特性", "当冷却完毕时，用魔法锤代替昏乱", BLU.JobID)]
        BLU_Addle = 70007,
        ...
        [BlueInactive(BLU.BasicInstinct)] [ParentCombo(BLU_FinalSting)] [CustomComboInfo("单挑模式", "如果你在单挑副本，使用斗争本能。", BLU.JobID)]
        BLU_SoloMode = 70011,

        [BlueInactive(BLU.HydroPull)] [ParentCombo(BLU_Ultravibrate)] [CustomComboInfo("水力吸引设置", "在使用寒冰咆哮之前先用水力吸引。", BLU.JobID)]
        BLU_HydroPull = 70012,

        [BlueInactive(BLU.JKick)] [ParentCombo(BLU_PrimalCombo)] [CustomComboInfo("正义飞踢选项", "将正义飞踢加入蛮神技能选项", BLU.JobID)]
        ...
        [BlueInactive(BLU.SonicBoom, BLU.SharpenedKnife)] [CustomComboInfo("音爆选项", "在近战范围内，使用锋利菜刀替代音爆。", BLU.JobID)]
        BLU_MeleeCombo = 70016,

        [BlueInactive(BLU.MatraMagic)] [ParentCombo(BLU_PrimalCombo)] [CustomComboInfo("马特拉魔法选项", "将马特拉魔法添加到蛮神特性中", BLU.JobID)]
        BLU_PrimalCombo_Matra = 70017,

        [BlueInactive(BLU.Surpanakha)] [ParentCombo(BLU_PrimalCombo)] [CustomComboInfo("穿甲散弹选项", "将穿甲散弹添加到蛮神特性中", BLU.JobID)]
        BLU_PrimalCombo_Suparnakha = 70018,

        [BlueInactive(BLU.PhantomFlurry)] [ParentCombo(BLU_PrimalCombo)] [CustomComboInfo("鬼宿脚选项", "将鬼宿脚添加到蛮神特性中", BLU.JobID)]
        BLU_PrimalCombo_PhantomFlurry = 70019,

        [BlueInactive(BLU.Nightbloom, BLU.Bristle)] [ParentCombo(BLU_PrimalCombo)] [CustomComboInfo("月下彼岸花选项", "将月下彼岸花添加到蛮神特性中", BLU.JobID)]
        ...
        [ParentCombo(BRD_ST_SimpleMode)] [CustomComboInfo("简易诗人Dots", "如果目标身上不存在风/毒dot，开启此选项会在连击中加入风/毒箭。", BRD.JobID, 0, "", "")]
        BRD_Simple_DoT = 3010,

        [ParentCombo(BRD_ST_SimpleMode)] [CustomComboInfo("简易诗人唱歌", "这个选项将诗人的三首歌加入简易诗人功能里", BRD.JobID, 0, "", "")]
        BRD_Simple_Song = 3011,

        [ParentCombo(BRD_AoE_oGCD)] [CustomComboInfo("唱歌相关设置", "在AOE连击中加入三首歌循环。", BRD.JobID, 0, "", "")]
        BRD_oGCDSongs = 3012,
        ...
        [ReplaceSkill(BRD.QuickNock, BRD.Ladonsbite)] [CustomComboInfo("简易诗人(AOE)", "连珠箭/百首龙牙箭 插入能力技。", BRD.JobID, 0, "", "")]
        BRD_AoE_SimpleMode = 3015,

        [ParentCombo(BRD_AoE_SimpleMode)] [CustomComboInfo("简易诗人唱歌(AOE)", "在简单的AOE中插入歌曲。", BRD.JobID, 0, "", "")]
        BRD_AoE_Simple_Songs = 3016,

        [ParentCombo(BRD_ST_SimpleMode)] [CustomComboInfo("简易诗人Buffs", "自动插入Buff技能。", BRD.JobID, 0, "", "")]
        BRD_Simple_Buffs = 3017,

        [ParentCombo(BRD_Simple_Buffs)] [CustomComboInfo("光明神的最终乐章替换设置", "当可用时自动插入光明神的最终乐章。", BRD.JobID, 0, "", "")]
        BRD_Simple_BuffsRadiant = 3018,

        [ParentCombo(BRD_ST_SimpleMode)]
        [CustomComboInfo("防止资源浪费相关选项",
        ...
        [ParentCombo(BRD_ST_SimpleMode)] [CustomComboInfo("单体连击打断技能设置", "如果可用，在循环中加入打断技能", BRD.JobID, 0, "", "")]
        ...
        [ParentCombo(BRD_ST_SimpleMode)] [CustomComboInfo("一键循环异言设置", "将失血箭集中于最佳爆发期", BRD.JobID, 0, "", "")]
        ...
        [ParentCombo(BRD_AoE_Simple_Songs)] [CustomComboInfo("除外放浪神的小步舞曲", "不使用放浪神的小步舞曲", BRD.JobID, 0, "", "")]
        BRD_AoE_Simple_SongsExcludeWM = 3027,

        [ParentCombo(BRD_ST_SimpleMode)] [CustomComboInfo("内丹选项", "当低于此生命值百分比时，使用内丹", BRD.JobID, 0, "", "")]
        BRD_ST_SecondWind = 3028,

        [ParentCombo(BRD_AoE_SimpleMode)] [CustomComboInfo("内丹选项", "当低于此生命值百分比时，使用内丹", BRD.JobID, 0, "", "")]
        BRD_AoE_SecondWind = 3029,

        [Variant] [VariantParent(BRD_ST_SimpleMode, BRD_AoE_SimpleMode)] [CustomComboInfo("铁壁 选项", "冷却结束时使用多变铁壁", BRD.JobID)]
        BRD_Variant_Rampart = 3030,

        [Variant] [VariantParent(BRD_ST_SimpleMode, BRD_AoE_SimpleMode)] [CustomComboInfo("治疗 选项", "在下水道使用治疗当HP低于某个值", BRD.JobID)]
        ...
        [CustomComboInfo("Simple AoE Interrupt Option", "Includes an interrupt in the AoE rotation (if your current target can be interrupted).",
            DNC.JobID, 0, "", "")]
        ...
        [CustomComboInfo("Simple AoE Standard Fill Option",
        ...
        [CustomComboInfo("Simple AoE Technical Dance Option", "Includes Technical Step, all dance steps and Technical Finish in the AoE rotation.",
            DNC.JobID, 3, "", "")]
        DNC_AoE_Simple_TS = 4073,

        [ParentCombo(DNC_AoE_SimpleMode)]
        [ConflictingCombos(DNC_AoE_Simple_TS)]
        [CustomComboInfo("Simple AoE Tech Fill Option",
        ...
        [ParentCombo(DNC_AoE_SimpleMode)]
        [CustomComboInfo("Simple AoE Tech Devilment Option",
        ...
        [ParentCombo(DNC_AoE_SimpleMode)]
        [CustomComboInfo("Simple AoE Panic Heals Option",
        ...
        [ConflictingCombos(DRK_oGCD)] [ParentCombo(DRK_SouleaterCombo)] [CustomComboInfo("暗黑骑士能力技整合 设置", "将所有能力技整合至噬魂斩连击中.", DRK.JobID, 0, "", "")]
        ...
        [ParentCombo(DRK_MainComboCDs_Group)] [CustomComboInfo("蔑视厌恶特性", "当蔑视厌恶在冷却中将其插入主连击中.", DRK.JobID, 0, "", "")]
        DRK_蔑视厌恶 = 50041,
        ...
        [ParentCombo(DRK_StalwartSoulCombo)] [CustomComboInfo("吸血深渊特性", "当你的血量低于60%时，在刚魂连击中插入吸血深渊.", DRK.JobID, 0, "", "")]
        DRK_AoE_AbyssalDrain = 5013,

        [ParentCombo(DRK_StalwartSoulCombo)] [CustomComboInfo("AOE暗影使者特性", "在刚魂连击中插入暗影使者.", DRK.JobID, 0, "", "")]
        DRK_AoE_Shadowbringer = 5014,

        [ParentCombo(DRK_StalwartSoulCombo)] [CustomComboInfo("暗影波动防溢出 设置", "当你的mp值高于8500或暗影状态即将结束时", DRK.JobID, 0, "", "")]
        DRK_AoE_ManaOvercap = 5015,

        [ParentCombo(DRK_SouleaterCombo)] [CustomComboInfo("暗血量表溢出特性", "当你的暗血不低于80时，将血溅整合到主连击。", DRK.JobID, 0, "", "")]
        ...
        [Variant] [VariantParent(DRK_SouleaterCombo, DRK_StalwartSoulCombo)] [CustomComboInfo("治疗 选项", "在下水道使用治疗当HP低于某个值", DRK.JobID)]
        DRK_Variant_Cure = 5032,

        [Variant] [VariantParent(DRK_SouleaterCombo, DRK_StalwartSoulCombo)] [CustomComboInfo("最后通牒 选项", "冷却结束时使用多变最后通牒", DRK.JobID)]
        ...
        [ParentCombo(GNB_ST_MainCombo)] [CustomComboInfo("烈牙与续剑整合到主连击", "将烈牙与续剑整合到主连击。关闭之后后续连击仍然会被替换到主连击。", GNB.JobID, 0, "", "")]
        ...
        [ParentCombo(GNB_ST_MainCombo)] [CustomComboInfo("绝枪战士能力技整合 设置", "选择是否在无情状态下将各种能力技整合至主连击中", GNB.JobID, 0, "", "")]
        GNB_ST_MainCombo_CooldownsGroup = 7004,

        [ParentCombo(GNB_ST_MainCombo_CooldownsGroup)] [CustomComboInfo("倍攻整合到主连击", "在无情状态下才在主连击中插入倍攻", GNB.JobID, 0, "", "")]
        GNB_ST_DoubleDown = 7005,

        [ParentCombo(GNB_ST_MainCombo_CooldownsGroup)] [CustomComboInfo("危险领域/爆破领域整合到主连击", "添加危险领域/爆破领域整合到主连击", GNB.JobID, 0, "", "")]
        ...
        [ReplaceSkill(GNB.烈牙GnashingFang)] [CustomComboInfo("烈牙连击", "将续剑添加到烈牙.", GNB.JobID, 0, "", "")]
        GNB_GF_Continuation = 7200,

        [ParentCombo(GNB_GF_Continuation)] [CustomComboInfo("无情整合到烈牙", "当无情冷却结束时将其整合到烈牙.", GNB.JobID, 0, "", "")]
        GNB_GF_NoMercy = 7201,

        [ParentCombo(GNB_GF_Continuation)] [CustomComboInfo("倍攻整合到烈牙", "当拥有无情BUFF时将倍攻整合到烈牙", GNB.JobID, 0, "", "")]
        ...
        [ParentCombo(GNB_AoE_MainCombo)] [CustomComboInfo("血壤整合至AoE连击", "当可用时在AoE连击中插入血壤.会先使用命运之环以确保使用血壤不会使晶壤溢出.", GNB.JobID, 0, "", "")]
        GNB_AoE_Bloodfest = 7303,

        [ParentCombo(GNB_AoE_MainCombo)] [CustomComboInfo("倍攻整合至AoE连击", "当倍攻可用且晶壤有2个以上时在AoE连击中插入倍攻.", GNB.JobID, 0, "", "")]
        GNB_AoE_DoubleDown = 7304,

        [ParentCombo(GNB_AoE_MainCombo)] [CustomComboInfo("危险领域AOE选项", "当可用时在AoE连击中插入危险领域.", GNB.JobID, 0, "", "")]
        GNB_AOE_DangerZone = 7305,

        [ParentCombo(GNB_AoE_MainCombo)] [CustomComboInfo("音速破AOE选项", "当可用时在AoE连击中插入音速破.", GNB.JobID, 0, "", "")]
        ...
        [ReplaceSkill(GNB.爆发击BurstStrike)] [CustomComboInfo("爆发击 Feature", "爆发击 相关功能", GNB.JobID, 0, "", "")]
        GNB_BS = 7400,


        [ParentCombo(GNB_BS)] [CustomComboInfo("爆发击续剑", "超高速可以使用的时候，超高速替换爆发击", GNB.JobID, 0, "", "")]
        ...
        [Variant] [VariantParent(GNB_ST_MainCombo, GNB_AoE_MainCombo)] [CustomComboInfo("精神镖选项", "当没有dot或dot剩余时间少于3s时，使用多变精神镖", GNB.JobID)]
        GNB_Variant_SpiritDart = 7033,

        [Variant] [VariantParent(GNB_ST_MainCombo, GNB_AoE_MainCombo)] [CustomComboInfo("治疗 选项", "在下水道使用治疗当HP低于某个值", GNB.JobID)]
        GNB_Variant_Cure = 7034,

        [Variant] [VariantParent(GNB_ST_MainCombo, GNB_AoE_MainCombo)] [CustomComboInfo("最后通牒 选项", "冷却结束时使用多变最后通牒", GNB.JobID)]
        ...
        [ParentCombo(MCH_ST_AdvancedMode)] [CustomComboInfo("Second Wind Option", "Use Second Wind when below the set HP percentage.", MCH.JobID)]
        ...
        [ParentCombo(MCH_AoE_AdvancedMode)] [CustomComboInfo("Reassemble Option", "Adds Reassemble to the rotation.", MCH.JobID)]
        ...
        [ReplaceSkill(MNK.ArmOfTheDestroyer)] [CustomComboInfo("破坏神冲 Combo", "将破坏神冲替换为其 Combo 链", MNK.JobID, 0, "", "")]
        MNK_AoE_SimpleMode = 9000,

        [ReplaceSkill(MNK.DragonKick)] [CustomComboInfo("双龙脚 --> 连击 功能", "在拥有连击效果提高时使用连击替换双龙脚。", MNK.JobID, 0, "", "")]
        MNK_DragonKick_Bootshine = 9001,

        [ReplaceSkill(MNK.TrueStrike)] [CustomComboInfo("双掌打特性", "如果你功力buff不足六秒，使用双掌打替换正拳。", MNK.JobID, 0, "", "")]
        MNK_TwinSnakes = 9011,

        [ReplaceSkill(MNK.Bootshine)] [ConflictingCombos(MNK_ST_SimpleMode)] [CustomComboInfo("基础循环", "整合一键基础循环", MNK.JobID, 0, "", "")]
        MNK_BasicCombo = 9002,

        [ReplaceSkill(MNK.PerfectBalance)] [CustomComboInfo("震脚特性", "如果你拥有三档脉轮，那么使用必杀技替换震脚。", MNK.JobID, 0, "", "")]
        MNK_PerfectBalance = 9003,

        [ReplaceSkill(MNK.DragonKick)] [CustomComboInfo("连击平衡特性", "如果你拥有三档脉轮，那么使用必杀技替换双龙脚。", MNK.JobID, 0, "", "")]
        MNK_BootshineBalance = 9004,

        [ReplaceSkill(MNK.HowlingFist, MNK.Enlightenment)] [CustomComboInfo("空鸣拳/万象斗气圈特性", "当你的斗气满时使用空鸣拳/万象斗气圈替换掉破坏神冲", MNK.JobID, 0, "", "")]
        ...
        [ReplaceSkill(MNK.MasterfulBlitz)] [CustomComboInfo("震脚特性+", "当震脚激活时，使用可用的技能替换必杀技。", MNK.JobID, 0, "", "")]
        MNK_PerfectBalance_Plus = 9007,

        [ParentCombo(MNK_ST_SimpleMode)] [CustomComboInfo("必杀技加入循环", "将必杀技加入循环", MNK.JobID, 0, "", "")]
        MNK_ST_Simple_MasterfulBlitz = 9008,

        [ParentCombo(MNK_AoE_SimpleMode)] [CustomComboInfo("必杀技加入AOE循环", "将必杀技添加进AoE循环。", MNK.JobID, 0, "", "")]
        MNK_AoE_Simple_MasterfulBlitz = 9009,

        [ReplaceSkill(MNK.RiddleOfFire)] [CustomComboInfo("红莲极意/义结金兰特性", "如果红莲极意进入冷却，那么使用义结金兰替换红莲极意。", MNK.JobID, 0, "", "")]
        MNK_Riddle_Brotherhood = 9012,

        [ParentCombo(MNK_ST_SimpleMode)] [CustomComboInfo("主连击CD整合", "当红莲极意进入冷却时，将各种能力技整合进连击。", MNK.JobID, 0, "", "")]
        MNK_ST_Simple_CDs = 9013,

        [ParentCombo(MNK_ST_Simple_CDs)] [CustomComboInfo("疾风极意整合", "将疾风极意整合进连击。", MNK.JobID, 0, "", "")]
        MNK_ST_Simple_CDs_RiddleOfWind = 9014,

        [ParentCombo(MNK_ST_Simple_CDs)] [CustomComboInfo("震脚整合", "将震脚整合进连击。", MNK.JobID, 0, "", "")]
        MNK_ST_Simple_CDs_PerfectBalance = 9015,

        [ParentCombo(MNK_ST_Simple_CDs)] [CustomComboInfo("义结金兰整合", "将义结金兰整合进连击。", MNK.JobID, 0, "", "")]
        MNK_ST_Simple_CDs_Brotherhood = 9016,

        [ParentCombo(MNK_ST_SimpleMode)] [CustomComboInfo("斗气整合", "将 斗气 消耗添加进主循环中", MNK.JobID, 0, "", "")]
        MNK_ST_Simple_Meditation = 9017,

        [ParentCombo(MNK_ST_SimpleMode)]
        [CustomComboInfo("阴阳开场",
        ...
        [ParentCombo(MNK_AoE_SimpleMode)] [CustomComboInfo("AoE 循环中的能力技使用", "AoE循环下，在红莲极意中插入各种能力技。", MNK.JobID, 0, "", "")]
        MNK_AoE_Simple_CDs = 9019,

        [ParentCombo(MNK_AoE_Simple_CDs)] [CustomComboInfo("疾风极意应用于 AoE 循环", "将疾风极意添加进一键 AoE 循环。", MNK.JobID, 0, "", "")]
        MNK_AoE_Simple_CDs_RiddleOfWind = 9020,

        [ParentCombo(MNK_AoE_Simple_CDs)] [CustomComboInfo("震脚应用于 AoE 循环", "将震脚添加进一键 AoE 循环", MNK.JobID, 0, "", "")]
        MNK_AoE_Simple_CDs_PerfectBalance = 9021,

        [ParentCombo(MNK_AoE_Simple_CDs)] [CustomComboInfo("义结金兰应用于 AoE 循环", "将义结金兰添加进一键 AoE 循环。", MNK.JobID, 0, "", "")]
        MNK_AoE_Simple_CDs_Brotherhood = 9022,

        [ParentCombo(MNK_AoE_SimpleMode)] [CustomComboInfo("斗气应用于 AoE 循环", "将斗气添加进一键 AoE 循环。", MNK.JobID, 0, "", "")]
        MNK_AoE_Simple_Meditation = 9023,

        [ParentCombo(MNK_AoE_SimpleMode)] [CustomComboInfo("轻身步法应用于 AoE 循环", "将轻身步法添加进一键 AoE 循环", MNK.JobID, 0, "", "")]
        MNK_AoE_Simple_Thunderclap = 9024,

        [ParentCombo(MNK_ST_SimpleMode)] [CustomComboInfo("轻身步法应用于单体循环", "将轻身步法添加进一键单体循环。", MNK.JobID, 0, "", "")]
        ...
        [ParentCombo(MNK_ST_Simple_Meditation)] [CustomComboInfo("斗气 选项", "当你超出攻击范围且不在起手/爆发期时，将循环替换为 斗气", MNK.JobID, 0, "", "")]
        MNK_ST_Meditation_Uptime = 9028,

        [ParentCombo(MNK_ST_SimpleMode)] [CustomComboInfo("动态真北选项", "当你不在触发增益状态的正确身位时，在触发增益状态前将 真北 加入到主循环中", MNK.JobID, 0, "", "")]
        MNK_TrueNorthDynamic = 9029,

        [Variant] [VariantParent(MNK_ST_SimpleMode, MNK_AoE_SimpleMode)] [CustomComboInfo("治疗 选项", "在下水道使用治疗当HP低于某个值", MNK.JobID)]
        MNK_Variant_Cure = 9030,

        [Variant] [VariantParent(MNK_ST_SimpleMode, MNK_AoE_SimpleMode)] [CustomComboInfo("铁壁 选项", "冷却结束时使用多变铁壁", MNK.JobID)]
        ...
        [ReplaceSkill(NIN.DeathBlossom)] [ConflictingCombos(NIN_AoE_AdvancedMode)] [CustomComboInfo("下忍模式 - AoE", "将血雨飞花替换为一键AOE连击", NIN.JobID)]
        ...
        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("飞刀 选项", "如果在近战攻击距离以外，将飞刀加入循环。", NIN.JobID)]
        NIN_ST_AdvancedMode_RangedUptime = 10004,

        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("夺取", "将 夺取 加入上忍模式循环", NIN.JobID)]
        ...
        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("攻其不备 选项", "将 攻其不备 加入一键循环", NIN.JobID)] //Has Config
        NIN_ST_AdvancedMode_TrickAttack = 10008,

        [ParentCombo(NIN_ST_AdvancedMode_TrickAttack)] [CustomComboInfo("在 攻其不备 前保留CD", "在 攻其不备 冷却结束前，停止使用CD超过15s的能力技", NIN.JobID)] //HasConfig
        NIN_ST_AdvancedMode_TrickAttack_Cooldowns = 10009,

        [ParentCombo(NIN_ST_AdvancedMode_TrickAttack)] [CustomComboInfo("延后 攻其不备", "进入战斗至少8s后再使用 攻其不备", NIN.JobID)]
        NIN_ST_AdvancedMode_TrickAttack_Delayed = 10010,

        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("忍术 选项", "将 忍术 加入上忍循环", NIN.JobID)]
        NIN_ST_AdvancedMode_Ninjitsus = 10011,

        [ParentCombo(NIN_ST_AdvancedMode_Ninjitsus)] [CustomComboInfo("保留1层充能", "防止一次性使用两个忍术", NIN.JobID)]
        NIN_ST_AdvancedMode_Ninjitsus_ChargeHold = 10012,

        [ParentCombo(NIN_ST_AdvancedMode_Ninjitsus)] [CustomComboInfo("使用 风魔手里剑", "使用忍术释放 风魔手里剑（仅在雷遁获取前生效）", NIN.JobID)]
        NIN_ST_AdvancedMode_Ninjitsus_FumaShuriken = 10013,

        [ParentCombo(NIN_ST_AdvancedMode_Ninjitsus)] [CustomComboInfo("使用 雷遁", "使用忍术释放 雷遁", NIN.JobID)]
        NIN_ST_AdvancedMode_Ninjitsus_Raiton = 10014,

        [ParentCombo(NIN_ST_AdvancedMode_Ninjitsus)] [CustomComboInfo("使用 水遁", "使用忍术释放 水遁", NIN.JobID)]
        NIN_ST_AdvancedMode_Ninjitsus_Suiton = 10015,

        [ParentCombo(NIN_ST_AdvancedMode_Ninjitsus)] [CustomComboInfo("使用 风遁", "使用忍术释放 风遁", NIN.JobID)]
        NIN_ST_AdvancedMode_Ninjitsus_Huton = 10016,

        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("断绝/梦幻三段", "将 断绝/梦幻三段 加入一键循环", NIN.JobID)]
        ...
        [ParentCombo(NIN_ST_AdvancedMode_Kassatsu)] [CustomComboInfo($"使用 冰晶乱流之术", "使用 生杀予夺 释放 冰晶乱流之术", NIN.JobID)]
        NIN_ST_AdvancedMode_Kassatsu_HyoshoRaynryu = 10019,

        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("强甲破点突 选项", "将 强甲破点突 加入一键循环", NIN.JobID)] //Has Config
        NIN_ST_AdvancedMode_ArmorCrush = 10020,

        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("风来刃 选项", "将 风来刃 加入一键循环", NIN.JobID)]
        NIN_ST_AdvancedMode_Huraijin = 10021,

        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("六道轮回 选项", "将 六道轮回 加入一键循环", NIN.JobID)] //Has Config
        NIN_ST_AdvancedMode_Bhavacakra = 10022,

        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("天地人 选项", "将 天地人 加入一键循环", NIN.JobID)]
        NIN_ST_AdvancedMode_TCJ = 10023,

        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("命水 选项", "将 命水 加入一键循环", NIN.JobID)]
        NIN_ST_AdvancedMode_Meisui = 10024,

        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("分身之术 选项", "将 分身之术 加入一键循环", NIN.JobID)]
        NIN_ST_AdvancedMode_Bunshin = 10025,

        [ParentCombo(NIN_ST_AdvancedMode_Bunshin)] [CustomComboInfo("残影镰鼬 选项", "将 残影镰鼬 加入一键循环", NIN.JobID)]
        NIN_ST_AdvancedMode_Bunshin_Phantom = 10026,

        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("月影雷兽爪/月影雷兽牙 选项", "将 月影雷兽爪/月影雷兽牙 加入一键循环", NIN.JobID)]
        NIN_ST_AdvancedMode_Raiju = 10027,

        [ParentCombo(NIN_ST_AdvancedMode_Raiju)] [CustomComboInfo("雷兽爪突进选项", "当处于攻击范围外时，使用 月影雷兽爪", NIN.JobID)]
        ...
        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("真北 选项", "将 真北 加入一键循环", NIN.JobID)]
        NIN_ST_AdvancedMode_TrueNorth = 10030,

        [ParentCombo(NIN_ST_AdvancedMode_TrueNorth)] [CustomComboInfo("仅在 强甲破点突 前使用", "仅在 强甲破点突 前使用 真北", NIN.JobID)]
        NIN_ST_AdvancedMode_TrueNorth_ArmorCrush = 10031,

        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("内丹选项", "将 内丹 加入一键循环", NIN.JobID)]
        NIN_ST_AdvancedMode_SecondWind = 10032,

        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("残影 选项", "将 残影 加入一键循环", NIN.JobID)]
        NIN_ST_AdvancedMode_ShadeShift = 10033,

        [ParentCombo(NIN_ST_AdvancedMode)] [CustomComboInfo("浴血 选项", "将 浴血 加入一键循环", NIN.JobID)]
        ...
        [ParentCombo(NIN_AoE_AdvancedMode)] [CustomComboInfo("断绝/梦幻三段", "将 断绝/梦幻三段 加入一键循环", NIN.JobID)]
        NIN_AoE_AdvancedMode_AssassinateDWAD = 10036,

        [ParentCombo(NIN_AoE_AdvancedMode)] [CustomComboInfo("忍术 选项", "将 忍术 加入上忍循环", NIN.JobID)]
        NIN_AoE_AdvancedMode_Ninjitsus = 10037,

        [ParentCombo(NIN_AoE_AdvancedMode_Ninjitsus)] [CustomComboInfo("保留1层充能", "防止一次性使用两个忍术", NIN.JobID)]
        NIN_AoE_AdvancedMode_Ninjitsus_ChargeHold = 10038,

        [ParentCombo(NIN_AoE_AdvancedMode_Ninjitsus)] [CustomComboInfo("使用 火遁", "使用忍术释放 火遁", NIN.JobID)]
        NIN_AoE_AdvancedMode_Ninjitsus_Katon = 10039,

        [ParentCombo(NIN_AoE_AdvancedMode_Ninjitsus)] [CustomComboInfo("使用 土遁", "使用忍术释放 土遁", NIN.JobID)]
        NIN_AoE_AdvancedMode_Ninjitsus_Doton = 10040,

        [ParentCombo(NIN_AoE_AdvancedMode_Ninjitsus)] [CustomComboInfo("使用 风遁", "使用忍术释放 风遁", NIN.JobID)]
        ...
        [ParentCombo(NIN_AoE_AdvancedMode_Kassatsu)] [CustomComboInfo("劫火灭却 选项", "将 劫火灭却之术 加入一键循环", NIN.JobID)]
        NIN_AoE_AdvancedMode_GokaMekkyaku = 10043,

        [ParentCombo(NIN_AoE_AdvancedMode)] [CustomComboInfo("风来刃 选项", "将 风来刃 加入一键循环", NIN.JobID)]
        NIN_AoE_AdvancedMode_Huraijin = 10044,

        [ParentCombo(NIN_AoE_AdvancedMode)] [CustomComboInfo("通灵之术·大虾蟆 选项", "将 通灵之术·大虾蟆 加入一键循环", NIN.JobID)]
        NIN_AoE_AdvancedMode_HellfrogMedium = 10045,

        [ParentCombo(NIN_AoE_AdvancedMode)] [CustomComboInfo("天地人 选项", "将 天地人 加入一键循环", NIN.JobID)]
        NIN_AoE_AdvancedMode_TCJ = 10046,

        [ParentCombo(NIN_AoE_AdvancedMode)] [CustomComboInfo("命水 选项", "将 命水 加入一键循环", NIN.JobID)]
        NIN_AoE_AdvancedMode_Meisui = 10047,

        [ParentCombo(NIN_AoE_AdvancedMode)] [CustomComboInfo("分身之术 选项", "将 分身之术 加入一键循环", NIN.JobID)]
        NIN_AoE_AdvancedMode_Bunshin = 10048,

        [ParentCombo(NIN_AoE_AdvancedMode_Bunshin)] [CustomComboInfo("残影镰鼬 选项", "将 残影镰鼬 加入一键循环", NIN.JobID)]
        NIN_AoE_AdvancedMode_Bunshin_Phantom = 10049,

        [ParentCombo(NIN_AoE_AdvancedMode)] [CustomComboInfo("内丹选项", "将 内丹 加入一键循环", NIN.JobID)]
        NIN_AoE_AdvancedMode_SecondWind = 10050,

        [ParentCombo(NIN_AoE_AdvancedMode)] [CustomComboInfo("残影 选项", "将 残影 加入一键循环", NIN.JobID)]
        NIN_AoE_AdvancedMode_ShadeShift = 10051,

        [ParentCombo(NIN_AoE_AdvancedMode)] [CustomComboInfo("浴血 选项", "将 浴血 加入一键循环", NIN.JobID)]
        NIN_AoE_AdvancedMode_Bloodbath = 10052,

        [ReplaceSkill(NIN.ArmorCrush)] [ConflictingCombos(NIN_ST_SimpleMode)] [CustomComboInfo("强甲破点突连击 选项", "使用 强甲破点突 做为连击的起始技.", NIN.JobID)]
        NIN_ArmorCrushCombo = 10053,

        [ConflictingCombos(NIN_ST_AdvancedMode_BalanceOpener, NIN_ST_AdvancedMode_BalanceOpener, NIN_ST_AdvancedMode_Kassatsu,
        ...
        [ReplaceSkill(NIN.TenChiJin)] [CustomComboInfo("命水 替换 天地人", "发动水遁之术 后，使用 命水 替换 天地人.\n推荐同时使用冷却CD监视插件.", NIN.JobID)]
        NIN_TCJMeisui = 10055,
        ...
        [ReplaceSkill(NIN.Hide)] [CustomComboInfo("隐遁 替换 夺取/攻其不备", "战斗状态下用 夺取 替换 隐遁，隐遁状态下用 攻其不备 替换 隐遁", NIN.JobID)]
        NIN_HideMug = 10057,

        [ReplaceSkill(NIN.AeolianEdge)] [CustomComboInfo("旋风刃 替换为 忍术", "此功能效果无效：当使用任意结印时，将 旋风刃 Combo 替换为 忍术。", NIN.JobID)]
        NIN_AeolianNinjutsu = 10058,

        [ReplaceSkill(NIN.Huraijin)] [CustomComboInfo("风来刃 替换为 雷兽", "当 月影雷兽爪 和 月影雷兽牙 可以使用时，替换 风来刃.", NIN.JobID)]
        NIN_HuraijinRaiju = 10059,

        [ParentCombo(NIN_HuraijinRaiju)] [CustomComboInfo("风来刃 替换为 月影雷兽牙", "当 月影雷兽牙 可以使用时，替换 风来刃.", NIN.JobID)]
        NIN_HuraijinRaiju_Fleeting = 10060,

        [ParentCombo(NIN_HuraijinRaiju)] [CustomComboInfo("风来刃 替换为 月影雷兽爪", "当 月影雷兽爪 可以使用时，替换 风来刃.", NIN.JobID)]
        NIN_HuraijinRaiju_Forked = 10061,

        [ReplaceSkill(NIN.Ten, NIN.Chi, NIN.Jin)] [CustomComboInfo("简化忍术", "简化忍术结印的操作.", NIN.JobID)]
        ...
        [ReplaceSkill(NIN.Huraijin)] [CustomComboInfo("风来刃/强点破甲突", "使用 绝风 后，用 强甲破点突 替换 风来刃", NIN.JobID)]
        NIN_HuraijinArmorCrush = 10064,

        [ParentCombo(NIN_ST_AdvancedMode_Ninjitsus_Raiton)] [CustomComboInfo("雷遁 选项", "将 雷遁 加入到循环", NIN.JobID)]
        NIN_ST_AdvancedMode_Raiton_Uptime = 10065,

        [ParentCombo(NIN_ST_AdvancedMode_Bunshin_Phantom)] [CustomComboInfo("残影镰鼬 选项", "将 残影镰鼬 加入到循环", NIN.JobID)]
        NIN_ST_AdvancedMode_Phantom_Uptime = 10066,

        [ParentCombo(NIN_ST_AdvancedMode_Ninjitsus_Suiton)] [CustomComboInfo("水遁之术 选项", "将 水遁之术 加入到循环", NIN.JobID)]
        NIN_ST_AdvancedMode_Suiton_Uptime = 10067,

        [ParentCombo(NIN_ST_AdvancedMode_TrueNorth_ArmorCrush)] [CustomComboInfo("动态真北选项", "在强点破甲突前面插入一个真北，如果你不在正确的身位上.", NIN.JobID)]
       ...
       [ReplaceSkill(PLD.先锋剑FastBlade)] [CustomComboInfo("骑士高级模式 - 单目标[推荐]", $"自定义循环链(先锋剑)", PLD.JobID)]
        ...
        [ParentCombo(PLD_ST_AdvancedMode)] [CustomComboInfo("深奥之灵 / 偿赎剑选项", "添加 深奥之灵 / 偿赎剑 到自定义循环", PLD.JobID)]
        PLD_ST_AdvancedMode_SpiritsWithin = 11006,

        [ParentCombo(PLD_ST_AdvancedMode)] [CustomComboInfo("盾阵 / 圣盾阵选项", "添加 盾阵 / 圣盾阵到自定义循环", PLD.JobID)]
        PLD_ST_AdvancedMode_Sheltron = 11007,

        [ParentCombo(PLD_ST_AdvancedMode)] [CustomComboInfo("沥血剑选项", "添加 沥血剑 到自定义循环", PLD.JobID)]
        PLD_ST_AdvancedMode_GoringBlade = 11008,

        [ParentCombo(PLD_ST_AdvancedMode)] [CustomComboInfo("圣灵选项", "添加 圣灵到自定义循环", PLD.JobID)]
        PLD_ST_AdvancedMode_HolySpirit = 11009,

        [ParentCombo(PLD_ST_AdvancedMode)] [CustomComboInfo("安魂祈祷", "添加 安魂祈祷到自定义循环", PLD.JobID)]
        ...
        [ParentCombo(PLD_ST_AdvancedMode)] [CustomComboInfo("赎罪剑 Option", "Adds 赎罪剑 to Advanced Mode", PLD.JobID)]
        PLD_ST_AdvancedMode_Atonement = 11012,

        [ParentCombo(PLD_ST_AdvancedMode)] [CustomComboInfo("悔罪选项", "添加 悔罪 到自定义循环", PLD.JobID)]
        ...
        [ParentCombo(PLD_AoE_AdvancedMode)] [CustomComboInfo("深奥之灵 / 偿赎剑选项", "添加 深奥之灵 / 偿赎剑到自定义循环", PLD.JobID)]
        PLD_AoE_AdvancedMode_SpiritsWithin = 11017,

        [ParentCombo(PLD_AoE_AdvancedMode)] [CustomComboInfo("厄运流转选项", "添加 厄运流转 到自定义循环.", PLD.JobID)]
        PLD_AoE_AdvancedMode_CircleOfScorn = 11018,

        [ParentCombo(PLD_AoE_AdvancedMode)] [CustomComboInfo("安魂祈祷选项", "添加 安魂祈祷 到自定义循环.", PLD.JobID)]
        PLD_AoE_AdvancedMode_Requiescat = 11019,

        [ParentCombo(PLD_AoE_AdvancedMode)] [CustomComboInfo("圣环选项", "添加 圣环到自定义循环.", PLD.JobID)]
        PLD_AoE_AdvancedMode_HolyCircle = 11020,

        [ParentCombo(PLD_AoE_AdvancedMode)] [CustomComboInfo("悔罪Option", "添加 悔罪到自定义循环", PLD.JobID)]
        PLD_AoE_AdvancedMode_Confiteor = 11021,

        [ParentCombo(PLD_AoE_AdvancedMode)] [CustomComboInfo("信仰/真理/英勇之剑选项", "添加 信仰/真理/英勇之剑 到自定义循环", PLD.JobID)]
        PLD_AoE_AdvancedMode_Blades = 11022,

        [ParentCombo(PLD_AoE_AdvancedMode)] [CustomComboInfo("盾阵 / 圣盾阵选项", "添加 盾阵 / 圣盾阵 到自定义循环", PLD.JobID)]
        PLD_AoE_AdvancedMode_Sheltron = 11023,


        [ReplaceSkill(PLD.安魂祈祷Requiescat)] [CustomComboInfo("安魂祈祷替换选项", "当安魂祈祷状态下用下面的技能替换安魂祈祷", PLD.JobID)]
        PLD_Requiescat_Options = 11024,

        [ReplaceSkill(PLD.深奥之灵SpiritsWithin, PLD.偿赎剑Expiacion)] [CustomComboInfo("深奥之灵/偿赎剑/厄运流转替换选项", "当厄运流转冷却用(深奥之灵/偿赎剑)代替(好像有bug).", PLD.JobID)]
        ...
        */
        ...
        [ReplaceSkill(RDM.Jolt, RDM.Jolt2)] [CustomComboInfo("赤魔简单模式 - 单目标", "启用以下所有选项.", RDM.JobID, 1)]
        RDM_ST_DPS = 13000,

        [ParentCombo(RDM_ST_DPS)] [CustomComboInfo("魔三连起手", "以【魔三连】作为起手代替【摇荡】（必须在近战距离内）", RDM.JobID, 110)]
        RDM_Balance_Opener = 13110,

        [ParentCombo(RDM_Balance_Opener)] [CustomComboInfo("无视魔元", "无视魔元是否平衡，但所有技能都必须在可用状态", RDM.JobID, 111)]
        RDM_Balance_Opener_AnyMana = 13111,

        [ParentCombo(RDM_ST_DPS)] [CustomComboInfo("赤疾风 / 赤闪雷 替代", "以【赤疾风/赤闪雷（或其升级）】代替【摇荡】", RDM.JobID, 210)]
        RDM_ST_ThunderAero = 13210,

        [ParentCombo(RDM_ST_ThunderAero)] [CustomComboInfo("促进 替代", "当没有【赤飞石/赤火炎预备】时，添加【促进】", RDM.JobID, 211)]
        RDM_ST_ThunderAero_Accel = 13211,

        [ParentCombo(RDM_ST_ThunderAero_Accel)] [CustomComboInfo("在循环中使用 即刻咏唱", "当所有短CD技都用完后，添加【即刻咏唱】", RDM.JobID, 212)]
        RDM_ST_ThunderAero_Accel_Swiftcast = 13212,

        [ParentCombo(RDM_ST_DPS)] [CustomComboInfo("赤飞石 / 赤火炎 替代", "以【赤飞石/赤火炎】代替【摇荡】", RDM.JobID, 220)]
        RDM_ST_FireStone = 13220,

        [ParentCombo(RDM_ST_DPS)] [CustomComboInfo("能力技 设置", "在循环中加入能力技", RDM.JobID, 240)]
        RDM_ST_oGCD = 13240,

        [ParentCombo(RDM_ST_DPS)] [CustomComboInfo("魔三连 设置", "在循环中加入魔三连（必须在近战范围内或启用了【使用短兵相接接近目标】）", RDM.JobID, 410)]
        RDM_ST_MeleeCombo = 13410,

        [ParentCombo(RDM_ST_MeleeCombo)] [CustomComboInfo("倍增与鼓励使用 设置", "加入倍增与鼓励（必须在近战范围内或启用了【使用短兵相接接近目标】）", RDM.JobID, 411)]
        RDM_ST_MeleeCombo_ManaEmbolden = 13411,

        [ParentCombo(RDM_ST_MeleeCombo_ManaEmbolden)] [CustomComboInfo("倍增与鼓励延后使用 设置", "延后使用这两个技能直到你能打出两套魔三连", RDM.JobID, 412)]
        RDM_ST_MeleeCombo_ManaEmbolden_DoubleCombo = 13412,

        [ParentCombo(RDM_ST_MeleeCombo)] [CustomComboInfo("使用短兵相接接近目标 设置", "当你不在近战范围内并魔元足够你开始魔三连的时候，使用短兵相接接近目标", RDM.JobID, 430)]
        RDM_ST_MeleeCombo_CorpsGapCloser = 13430,

        [ParentCombo(RDM_ST_MeleeCombo)] [CustomComboInfo("不平衡魔元处理 设置", "通过使用【促进】来平衡魔元以开始魔三连", RDM.JobID, 410)]
        RDM_ST_MeleeCombo_UnbalanceMana = 13440,

        [ParentCombo(RDM_ST_DPS)] [CustomComboInfo("近战技能终结 设置", "在魔三连后加入【赤神圣/赤核爆】等终结技能", RDM.JobID, 510)]
        RDM_ST_MeleeFinisher = 13510,

        [ParentCombo(RDM_ST_DPS)] [CustomComboInfo("在循环使用 醒梦", "当MP小于指定值时，使用【醒梦】", RDM.JobID, 610)]
        RDM_ST_Lucid = 13610,
        ...
        [ReplaceSkill(RDM.Scatter, RDM.Impact)] [CustomComboInfo("赤魔简单模式 - AOE", "启用以下所有选项", RDM.JobID, 310)]
        RDM_AoE_DPS = 13310,

        [ParentCombo(RDM_AoE_DPS)] [ReplaceSkill(RDM.Scatter, RDM.Impact)] [CustomComboInfo("AOE的 促进 选项", "使用【促进】来增加伤害", RDM.JobID, 320)]
        RDM_AoE_Accel = 13320,

        [ParentCombo(RDM_AoE_Accel)] [CustomComboInfo("对单目标时使用即刻咏唱 设置", "当所有的短CD技能用完了或你低于50级时，在循环中加入【即刻咏唱】", RDM.JobID, 321)]
        RDM_AoE_Accel_Swiftcast = 13321,

        [ParentCombo(RDM_AoE_Accel)] [CustomComboInfo("使用 促进 设置", "只在能力技时间窗内使用【促进】", RDM.JobID, 322)]
        ...
        [ParentCombo(RDM_AoE_MeleeCombo)] [CustomComboInfo("使用短兵相接接近目标 设置", "当你不在近战范围内并魔元足够你开始魔三连的时候，使用短兵相接接近目标", RDM.JobID, 430)]
        RDM_AoE_MeleeCombo_CorpsGapCloser = 13422,

        [ParentCombo(RDM_AoE_MeleeCombo)] [CustomComboInfo("不平衡魔元处理 设置", "使用促进触发黑白魔元中较低的一方以便使用魔三连.", RDM.JobID, 410)]
        RDM_AoE_MeleeCombo_UnbalanceMana = 13423,

        [ParentCombo(RDM_AoE_DPS)] [CustomComboInfo("近战技能终结 设置", "在魔三连后加入【赤神圣/赤核爆】等终结技能", RDM.JobID, 510)]
        RDM_AoE_MeleeFinisher = 13424,

        [ParentCombo(RDM_AoE_DPS)] [CustomComboInfo("在循环使用 醒梦", "当MP小于指定值时，使用【醒梦】", RDM.JobID, 610)]
        RDM_AoE_Lucid = 13425,
        ...
        [ReplaceSkill(RDM.Displacement)] [CustomComboInfo("移转与短兵相接替换 设置", "当距离过远时替换移转为短兵相接.", RDM.JobID, 810)]
        RDM_CorpsDisplacement = 13810,

        [ReplaceSkill(RDM.Embolden)] [CustomComboInfo("鼓励与倍增替换 设置", "当鼓励在冷却时替换其为倍增.", RDM.JobID, 820)]
        RDM_EmboldenManafication = 13820,

        [ReplaceSkill(RDM.MagickBarrier)] [CustomComboInfo("抗死与昏乱替换 设置", "当抗死在冷却时替换其为昏乱.", RDM.JobID, 820)]
        RDM_MagickBarrierAddle = 13821,

        [Variant] [VariantParent(RDM_ST_DPS, RDM_AoE_DPS)] [CustomComboInfo("铁壁 选项", "Use Variant Rampart on cooldown. Replaces Jolts.", RDM.JobID)]
        ...
        */
        ...
        [ParentCombo(SGE_ST_DPS)] [CustomComboInfo("循环加入醒梦", "当MP小于滑块值时，将醒梦整合至此循环", SGE.JobID, 120, "", "")]
        SGE_ST_DPS_Lucid = 14110,

        [ParentCombo(SGE_ST_DPS)] [CustomComboInfo("均衡注药 设置", "自动插入均衡注药续Dot.", SGE.JobID, 110, "", "")]
        SGE_ST_DPS_EDosis = 14120,

        [ParentCombo(SGE_ST_DPS)] [CustomComboInfo("移动选项", "移动时使用选择的顺发技能", SGE.JobID, 112, "", "")]
        SGE_ST_DPS_Movement = 14130,

        [ParentCombo(SGE_ST_DPS)] [CustomComboInfo("发炎 选项", "使用发炎如果它可用并且在距离内", SGE.JobID, 111, "", "")]
        SGE_ST_DPS_Phlegma = 14140,

        [ParentCombo(SGE_ST_DPS)] [CustomComboInfo("心关 提醒选项", "当没有 心关 状态时插入 心关。", SGE.JobID, 122, "", "")]
        ...
        [ReplaceSkill(SGE.Phlegma, SGE.Phlegma2, SGE.Phlegma3)] [CustomComboInfo("AoE DPS连击", "", SGE.JobID, 200, "", "")]
        SGE_AoE_DPS = 14200,

        [ParentCombo(SGE_AoE_DPS)] [CustomComboInfo("箭毒 无发炎层数时选项", "当没有发炎层数时使用箭毒，优先于失衡", SGE.JobID, 210, "", "")]
        SGE_AoE_DPS_NoPhlegmaToxikon = 14210,

        [ParentCombo(SGE_AoE_DPS)] [CustomComboInfo("箭毒 超出发炎范围时选项", "当超出发炎范围时使用箭毒，优先于失衡", SGE.JobID, 220, "", "")]
        SGE_AoE_DPS_OutOfRangeToxikon = 14220,

        [ParentCombo(SGE_AoE_DPS)] [CustomComboInfo("失衡 无发炎层数时选项", "当超出发炎范围时使用失衡", SGE.JobID, 230, "", "")]
        SGE_AoE_DPS_NoPhlegmaDyskrasia = 14230,

        [ParentCombo(SGE_AoE_DPS)] [CustomComboInfo("失衡 无目标锁定选项", "当无目标锁定时使用失衡", SGE.JobID, 240, "", "")]
        SGE_AoE_DPS_NoTargetDyskrasia = 14240,

        [ParentCombo(SGE_AoE_DPS)] [CustomComboInfo("循环加入醒梦", "当MP小于滑块值时，将醒梦整合至此循环", SGE.JobID, 250, "", "")]
        ...
        [ReplaceSkill(SGE.Diagnosis)] [CustomComboInfo("单目标治疗功能", "支持软目标。\n以下选项按优先顺序排列。", SGE.JobID, 300, "", "")]
        SGE_ST_Heal = 14300,

        [ParentCombo(SGE_ST_Heal)] [CustomComboInfo("康复 选项", "当你的目标有一个可清除的debuff时则使用 康复。", SGE.JobID, 301, "", "")]
        SGE_ST_Heal_Esuna = 14301,

        [ParentCombo(SGE_ST_Heal)] [CustomComboInfo("心关", "如果心关从未使用过，则对选中目标使用心关。", SGE.JobID, 305, "", "")]
        ...
        [ParentCombo(SGE_ST_Heal)] [CustomComboInfo("拯救选项", "插入拯救.", SGE.JobID, 306, "", "")]
        SGE_ST_Heal_Soteria = 14330,

        [ParentCombo(SGE_ST_Heal)] [CustomComboInfo("活化选项", "插入活化.", SGE.JobID, 307, "", "")]
        SGE_ST_Heal_Zoe = 14340,

        [ParentCombo(SGE_ST_Heal)] [CustomComboInfo("消化选项", "当盾值存在时激活消化。", SGE.JobID, 309, "", "")]
        SGE_ST_Heal_Pepsis = 14350,

        [ParentCombo(SGE_ST_Heal)] [CustomComboInfo("白牛清汁选项", "插入白牛清汁.", SGE.JobID, 303, "", "")]
        SGE_ST_Heal_Taurochole = 14360,

        [ParentCombo(SGE_ST_Heal)] [CustomComboInfo("输血选项", "插入输血.", SGE.JobID, 310, "", "")]
        SGE_ST_Heal_Haima = 14370,

        [ParentCombo(SGE_ST_Heal)] [CustomComboInfo("根素选项", "当没有蛇胆时插入根素.", SGE.JobID, 304, "", "")]
        SGE_ST_Heal_Rhizomata = 14380,

        [ParentCombo(SGE_ST_Heal)] [CustomComboInfo("混合选项", "插入混合.", SGE.JobID, 308, "", "")]
        SGE_ST_Heal_Krasis = 14390,

        [ParentCombo(SGE_ST_Heal)] [CustomComboInfo("灵橡清汁选项", "插入灵橡清汁.", SGE.JobID, 302, "", "")]
        ...
        [ReplaceSkill(SGE.Prognosis)] [CustomComboInfo("群体治疗技能一键整合至预后", "按照个人喜好制定群体治疗技能一键整合方式.", SGE.JobID, 500, "", "")]
        SGE_AoE_Heal = 14500,


        [ParentCombo(SGE_AoE_Heal)] [CustomComboInfo("自生", "自动插入自生。", SGE.JobID, 504, "", "")]
        ...
        [ParentCombo(SGE_AoE_Heal)] [CustomComboInfo("整体论", "自动插入整体论。", SGE.JobID, 505, "", "")]
        SGE_AoE_Heal_Holos = 14530,

        [ParentCombo(SGE_AoE_Heal)] [CustomComboInfo("泛输血", "自动插入泛输血。", SGE.JobID, 506, "", "")]
        SGE_AoE_Heal_Panhaima = 14540,

        [ParentCombo(SGE_AoE_Heal)] [CustomComboInfo("消化选项", "当盾值存在时激活消化。", SGE.JobID, 507, "", "")]
        SGE_AoE_Heal_Pepsis = 14550,

        [ParentCombo(SGE_AoE_Heal)] [CustomComboInfo("寄生清汁", "整合寄生清汁.", SGE.JobID, 503, "", "")]
        SGE_AoE_Heal_Ixochole = 14560,

        [ParentCombo(SGE_AoE_Heal)] [CustomComboInfo("坚角清汁", "整合坚角清汁.", SGE.JobID, 502, "", "")]
        SGE_AoE_Heal_Kerachole = 14570,

        [ParentCombo(SGE_AoE_Heal)] [CustomComboInfo("根素选项", "当没有蛇胆时插入根素.", SGE.JobID, 501, "", "")]
        ...
        [ReplaceSkill(SGE.Taurochole, SGE.Druochole, SGE.Ixochole, SGE.Kerachole)] [CustomComboInfo("根素 设置", "蛇胆不满时插入根素", SGE.JobID, 600, "", "")]
        SGE_Rhizo = 14600,

        [ReplaceSkill(SGE.Druochole)] [CustomComboInfo("替换灵橡清汁为白牛清汁 设置", "当白牛青汁可用时，替换灵橡清汁为白牛清汁.", SGE.JobID, 700, "", "")]
        SGE_DruoTauro = 14700,

        [ReplaceSkill(SGE.Pneuma)] [CustomComboInfo("将活化整合至魂灵风息 设置", "魂灵风息变为活化，使用后变回魂灵风息.", SGE.JobID, 701, "", "")] //Temporary to keep the order
        ...
        [Variant] [VariantParent(SGE_ST_DPS, SGE_AoE_DPS)] [CustomComboInfo("铁壁 选项", "冷却结束时使用多变铁壁", SGE.JobID)]
        ...
        [ReplaceSkill(SAM.Kasha, SAM.Gekko, SAM.Yukikaze)] [CustomComboInfo("武士单体技能替代选项", "当剑气达到或超过所选数量时，将必杀剑·震天添加到单体连击中。", SAM.JobID, 0, "", "")]
        SAM_ST_Overcap = 15001,

        [ReplaceSkill(SAM.Mangetsu, SAM.Oka)] [CustomComboInfo("武士AOE技能替代选项", "当剑气达到或超过所选数量时，将必杀剑·九天添加到主要AOE连击中。", SAM.JobID, 0, "", "")]
        ...
        [ParentCombo(SAM_ST_GekkoCombo)] [CustomComboInfo("燕飞特性", "当你离开射程时，使用燕飞。", SAM.JobID, 0, "", "")]
        ...
        [ParentCombo(SAM_ST_GekkoCombo)] [CustomComboInfo("花车连击加入循环", "将花车连击加入主循环。在明镜止水期间也会加入花车连击", SAM.JobID, 0, "", "")]
        SAM_ST_GekkoCombo_Kasha = 15006,

        [ConflictingCombos(SAM_GyotenYaten)]
        [ParentCombo(SAM_ST_GekkoCombo)]
        [CustomComboInfo("Level 90 Samurai Opener",
        ...
        [ParentCombo(SAM_ST_GekkoCombo)] [CustomComboInfo("主连击CD整合", "将CD技能加入循环", SAM.JobID, 0, "", "")]
        ...
        [ParentCombo(SAM_ST_GekkoCombo_CDs)] [CustomComboInfo("将奥义斩浪加入循环", "在未移动和技能冷却完毕的情况下，将奥义斩浪和回返斩浪加入循环。", SAM.JobID, 0, "", "")]
        SAM_ST_GekkoCombo_CDs_OgiNamikiri = 15011,

        [ParentCombo(SAM_ST_GekkoCombo_CDs_OgiNamikiri)]
        [CustomComboInfo("奥义斩浪爆发选项",
        ...
        [ParentCombo(SAM_ST_GekkoCombo_CDs)] [CustomComboInfo("将照破加入循环", "当拥有三档剑压时，将照破加入循环", SAM.JobID, 0, "", "")]
        ...
        [ParentCombo(SAM_ST_Overcap)] [CustomComboInfo("震天 选项", "当目标血量小于此百分比时，只要有25点剑气就将震天加入循环.", SAM.JobID, 0, "", "")]
        ...
        [ReplaceSkill(SAM.Yukikaze)] [CustomComboInfo("雪风连", "替换雪风为相应连击。", SAM.JobID, 0, "", "")]
        SAM_ST_YukikazeCombo = 15018,

        [ReplaceSkill(SAM.Kasha)] [CustomComboInfo("花车连", "替换花车为相应连击。", SAM.JobID, 0, "", "")]
        ...
        [ReplaceSkill(SAM.Mangetsu)] [CustomComboInfo("满月连", "用满月连击的组合代替满月。\n如果所有子选项都被选中，将变成一个完整的一键AOE循环（高级武士）。", SAM.JobID, 0, "", "")]
        ...
        [ParentCombo(SAM_AoE_MangetsuCombo)] [CustomComboInfo("将奥义斩浪加入AOE连击", "在未移动和技能冷却完毕的情况下，将奥义斩浪加入循环。", SAM.JobID, 0, "", "")]
        SAM_AoE_MangetsuCombo_OgiNamikiri = 15023,

        [ParentCombo(SAM_AoE_MangetsuCombo)] [CustomComboInfo("将无明照破加入AOE连击", "当拥有三档剑压时，将无明照破加入AOE循环", SAM.JobID, 0, "", "")]
        ...
        [ParentCombo(SAM_AoE_MangetsuCombo)] [CustomComboInfo("明镜止水 添加到 满月 连击", "明镜止水 添加到 满月 连击。", SAM.JobID, 0, "", "")]
        ...
        [ParentCombo(SAM_AoE_MangetsuCombo)] [CustomComboInfo("叶隐 添加到 满月 连击", "当有三层剑压时，将 叶隐 添加到 满月 连击。", SAM.JobID, 0, "", "")]
        SAM_AoE_MangetsuCombo_Hagakure = 15041,

        [ReplaceSkill(SAM.Oka)] [CustomComboInfo("樱花连", "替换樱花为相应连击。", SAM.JobID, 0, "", "")]
        SAM_AoE_OkaCombo = 15026,

        [ParentCombo(SAM_AoE_OkaCombo)]
        [ConflictingCombos(SAM_AoE_MangetsuCombo_Oka)]
        [CustomComboInfo("樱花双目标功能",
        ...
        [ReplaceSkill(SAM.Iaijutsu)] [CustomComboInfo("居合术功能", "居合术整合", SAM.JobID, 0, "", "")]
        SAM_Iaijutsu = 15028,

        [ParentCombo(SAM_Iaijutsu)] [CustomComboInfo("使用燕回返代替居合术", "当闪为空时，用燕回返代替居合术。", SAM.JobID, 0, "", "")]
        SAM_Iaijutsu_TsubameGaeshi = 15029,

        [ParentCombo(SAM_Iaijutsu)] [CustomComboInfo("照破 替换 居合术", "当剑压积累到3档时，替换居合术为照破。", SAM.JobID, 0, "", "")]
        SAM_Iaijutsu_Shoha = 15030,

        [ParentCombo(SAM_Iaijutsu)] [CustomComboInfo("使用奥义斩浪代替居合术", "处于奥义斩浪预备的时候，使用回奥义斩浪和返斩浪代替居合术。", SAM.JobID, 0, "", "")]
        ...
        [ReplaceSkill(SAM.Shinten)] [CustomComboInfo("照破 替换 必杀剑·震天", "当剑压积累到3档时，替换必杀剑·震天为照破。", SAM.JobID, 0, "", "")]
        ...
        [ReplaceSkill(SAM.Kyuten)] [CustomComboInfo("无名照破 替换 必杀剑·九天", "当剑压积累到3档时，替换必杀剑·九天为无名照破。", SAM.JobID, 0, "", "")]
        ...
        [CustomComboInfo("意气冲天 奥义斩浪 连击特性",
        ...
        [ReplaceSkill(SAM.Gekko, SAM.Yukikaze, SAM.Kasha)] [CustomComboInfo("真北 开关", "处于明镜止水状态时，将真北插入所有的单体连击", SAM.JobID, 0, "", "")]
        SAM_TrueNorth = 15038,
        ...
        [Variant] [VariantParent(SAM_ST_GekkoCombo, SAM_AoE_MangetsuCombo)] [CustomComboInfo("治疗 选项", "在下水道使用治疗当HP低于某个值", SAM.JobID)]
        SAM_Variant_Cure = 15047,

        [Variant] [VariantParent(SAM_ST_GekkoCombo, SAM_AoE_MangetsuCombo)] [CustomComboInfo("铁壁 选项", "冷却结束时使用多变铁壁", SAM.JobID)]
        ...
        */
        ...
        [ParentCombo(SCH_DPS)] [CustomComboInfo("醒梦选项", "当 MP 低于滑动条的值时在循环中加入醒梦", SCH.JobID, 110)]
        SCH_DPS_Lucid = 16110,

        [ParentCombo(SCH_DPS)] [CustomComboInfo("连环计", "将 连环计 加入到循环，并且防顶。", SCH.JobID, 120)]
        SCH_DPS_ChainStrat = 16120,

        [ParentCombo(SCH_DPS)] [CustomComboInfo("以太超流", "当自身没有以太超流层数时使用以太超流技能补充", SCH.JobID, 130)]
        SCH_DPS_Aetherflow = 16130,

        [ParentCombo(SCH_DPS)] [CustomComboInfo("能量吸收 插入选项", "在 以太超流 即将冷却完毕时，插入 能量吸收 消耗剩余豆子。", SCH.JobID, 131)]
        SCH_DPS_EnergyDrain = 16160,

        [ParentCombo(SCH_DPS_EnergyDrain)] [CustomComboInfo("能量吸收 爆发选项", "当 连环计 冷却完毕或少于10秒时，保留 能量吸收。", SCH.JobID, 133)]
        SCH_DPS_EnergyDrain_BurstSaver = 16161,

        [ParentCombo(SCH_DPS)] [CustomComboInfo("移动毁荡", "在移动时使用 毁坏。", SCH.JobID, 150)]
        SCH_DPS_Ruin2Movement = 16140,

        [ParentCombo(SCH_DPS)] [CustomComboInfo("毒菌/蛊毒法", "Automatic DoT uptime.", SCH.JobID, 140)]
        SCH_DPS_Bio = 16150,

        [ParentCombo(SCH_DPS)] [CustomComboInfo("转化 起手选项", "在战斗开始时使用 转化。", SCH.JobID, 170)]
        SCH_DPS_Dissipation_Opener = 16170,


        [ReplaceSkill(SCH.ArtOfWar, SCH.ArtOfWarII)] [CustomComboInfo("AoE DPS连击", "将 破阵法 替换为一键连击。", SCH.JobID, 3)]
        SCH_AoE = 16101,

        [ParentCombo(SCH_AoE)] [CustomComboInfo("醒梦选项", "当 MP 低于滑动条的值时在循环中加入醒梦", SCH.JobID)]
        SCH_AoE_Lucid = 16111,

        [ParentCombo(SCH_AoE)] [CustomComboInfo("以太超流", "当自身没有以太超流层数时使用以太超流技能补充", SCH.JobID)]
        ...
        [ReplaceSkill(SCH.FeyBlessing)] [CustomComboInfo("异想的祥光 替换 慰藉", "炽天使同行状态下，将 异想的祥光 变为 慰藉.", SCH.JobID, 9)]
        ...
        [ParentCombo(SCH_Fairy_Combo)] [CustomComboInfo("异想的祥光 替换 慰藉", "炽天使同行状态下，将 异想的祥光 变为 慰藉。", SCH.JobID)]
        SCH_Fairy_Combo_Consolation = 16241,

        [ReplaceSkill(SCH.Succor)] [CustomComboInfo("群体治疗技能一键整合至预后", "用以下选项替换 士气高扬之策：", SCH.JobID, 5)]
        SCH_AoE_Heal = 16250,

        [ParentCombo(SCH_AoE_Heal)] [CustomComboInfo("循环加入醒梦", "当MP不够使用士气高扬之策时，将醒梦加入到循环中。", SCH.JobID)]
        SCH_AoE_Heal_Lucid = 16251,

        [ParentCombo(SCH_AoE_Heal)] [CustomComboInfo("以太超流 选项", "当自身没有以太超流层数时使用以太超流技能补充", SCH.JobID)]
        SCH_AoE_Heal_Aetherflow = 16252,

        [ParentCombo(SCH_AoE_Heal_Aetherflow)] [CustomComboInfo("不屈不挠之策 独立选项", "只有在 不屈不挠之策 准备好的情况下才会使用 以太超流。", SCH.JobID)]
        SCH_AoE_Heal_Aetherflow_Indomitability = 16253,

        [ParentCombo(SCH_AoE_Heal)] [CustomComboInfo("不屈不挠之策 选项", "在 士气高扬之策 前优先使用 不屈不挠之策。", SCH.JobID)]
        ...
        [ParentCombo(SCH_ST_Heal)] [CustomComboInfo("醒梦选项", "当 MP 低于滑动条的值时在循环中加入醒梦", SCH.JobID, 1)]
        SCH_ST_Heal_Lucid = 16261,

        [ParentCombo(SCH_ST_Heal)] [CustomComboInfo("以太超流", "当自身没有以太超流层数时使用以太超流技能补充", SCH.JobID, 2)]
        SCH_ST_Heal_Aetherflow = 16262,

        [ParentCombo(SCH_ST_Heal)] [CustomComboInfo("康复 选项", "当你的目标有一个可清除的debuff时则使用 康复。", SGE.JobID, 3)]
        SCH_ST_Heal_Esuna = 16265,

        [ParentCombo(SCH_ST_Heal)] [CustomComboInfo("鼓舞激励之策 选项", "当没有 鼓舞 状态或目标生命值低于指定值时插入 鼓舞激励之策：", SCH.JobID, 4)]
        SCH_ST_Heal_Adloquium = 16263,


        [ParentCombo(SCH_ST_Heal)] [CustomComboInfo("生命活性法 选项", "当目标生命值低于指定值时插入 生命活性法：", SCH.JobID, 5)]
        ...
        [ParentCombo(SCH_Aetherflow)] [CustomComboInfo("秘策", "在 深谋远虑之策 或 不屈不挠之策 前优先使用 秘策。", SCH.JobID)]
        ...
        [ReplaceSkill(SCH.DeploymentTactics)] [CustomComboInfo("展开战术", "队友没有 鼓舞 状态时，将 展开战术 替换为 鼓舞激励之策。", SCH.JobID, 12)]
        SCH_DeploymentTactics = 16600,

        [ParentCombo(SCH_DeploymentTactics)] [CustomComboInfo("秘策", "当 秘策 冷却完毕且队友没有鼓舞状态时将 鼓舞激励之策 替换为 秘策。", SCH.JobID)]
        SCH_DeploymentTactics_Recitation = 16610,

        [Variant] [VariantParent(SCH_DPS_Bio, SCH_AoE)] [CustomComboInfo("精神镖选项", "当没有dot或dot剩余时间少于3s时，使用多变精神镖", SCH.JobID)]
        SCH_DPS_Variant_SpiritDart = 16700,

        [Variant] [VariantParent(SCH_DPS, SCH_AoE)] [CustomComboInfo("铁壁 选项", "冷却结束时使用多变铁壁", SCH.JobID)]
        ...
        [ParentCombo(SMN_Advanced_Combo)] [CustomComboInfo("螺旋气流-迦楼罗替换", "螺旋气流 可用时替换 毁荡和三重灾祸", SMN.JobID, 6, "", "")]
        SMN_Garuda_Slipstream = 17005,


        [ParentCombo(SMN_Advanced_Combo)] [CustomComboInfo("深红旋风-伊芙利特替换", "深红旋风 深红强袭 可用时替换 毁荡和三重灾祸", SMN.JobID, 7, "", "")]
        ...
        [ParentCombo(SMN_EDFester)] [CustomComboInfo("毁绝替换", "当没有以太超流层数时 自身处于毁绝准备中 并且能量吸收进入冷却，溃烂爆发技能变为毁绝，", SMN.JobID, 0, "", "")]
        SMN_EDFester_Ruin4 = 17013,

        [ParentCombo(SMN_Advanced_Combo)] [CustomComboInfo("循环加入能量吸收和能量抽取", "将能量系技能在冷却完毕后加入到循环和AOE循环中", SMN.JobID, 1, "", "")]
        SMN_Advanced_Combo_EDFester = 17014,

        [ParentCombo(SMN_Advanced_Combo)] [CustomComboInfo("循环加入三神召唤", "将三神召唤加入到循环和AOE循环中\n可选择召唤顺序.\n默认采用泰坦优先.", SMN.JobID, 3, "", "")]
        SMN_DemiEgiMenu_EgiOrder = 17016,

        [ParentCombo(SMN_Advanced_Combo)] [CustomComboInfo("循环加入灼热之光", "在循环和AOE循环中加入灼热之光\n冷却完毕立刻使用", SMN.JobID, 9, "", "")]
        SMN_SearingLight = 17018,

        [ParentCombo(SMN_SearingLight)] [CustomComboInfo("灼热之光爆发设置", "只在亚神召唤中使用灼热之光\n进阶选项在 高级能力技选项下\n不适用咏速套装", SMN.JobID, 0, "")]
        SMN_SearingLight_Burst = 170181, // Genesis, why must you be like this -K

        [ParentCombo(SMN_Advanced_Combo)] [CustomComboInfo("循环中加入亚神召唤", "循环和AOE循环中加入 龙神召唤 不死鸟召唤", SMN.JobID, 10, "", "")]
        SMN_Advanced_Combo_DemiSummons = 17020,

        [ParentCombo(SMN_Advanced_Combo)] [CustomComboInfo("即刻咏唱三神技能选项", "使用三神技能时自动使用即刻", SMN.JobID, 8, "", "")]
        ...
        [ParentCombo(SMN_SearingLight)] [CustomComboInfo("只在单循环中使用", "禁止此功能在AOE循环中使用", SMN.JobID, 2, "", "")]
        SMN_SearingLight_STOnly = 17036,


        [ParentCombo(SMN_DemiEgiMenu_oGCDPooling)] [CustomComboInfo("只在单循环中使用", "禁止此功能在AOE循环中使用", SMN.JobID, 3, "", "")]
        SMN_DemiEgiMenu_oGCDPooling_Only = 17037,


        [ParentCombo(SMN_DemiEgiMenu_SwiftcastEgi)] [CustomComboInfo("只在单循环中使用", "禁止此功能在AOE循环中使用", SMN.JobID, 2, "", "")]
        SMN_DemiEgiMenu_SwiftcastEgi_Only = 17038,


        [ParentCombo(SMN_ESPainflare)]
        [CustomComboInfo("毁绝替换痛苦核爆", "Changes Painflare to Ruin IV when out of Aetherflow stacks, Energy Siphon is on cooldown, and Ruin IV is up.",
            SMN.JobID, 0, "", "")]
        ...
        [ReplaceSkill(WAR.StormsEye)] [CustomComboInfo("暴风碎连击", "将暴风碎替换为暴风碎连击", WAR.JobID, 0, "", "")]
        War_ST_StormsEye = 18001,

        [ReplaceSkill(WAR.Overpower)] [CustomComboInfo("超压斧连击", "将超压斧替换为AOE连击", WAR.JobID, 0, "", "")]
        WAR_AoE_Overpower = 18002,

        [ParentCombo(WAR_ST_StormsPath)] [CustomComboInfo("兽魂监控", "如果兽魂快溢出了，将消耗兽魂的技能加入到暴风斩连击和AOE连击", WAR.JobID, 0, "", "")]
        WAR_ST_StormsPath_OvercapProtection = 18003,

        [ReplaceSkill(WAR.NascentFlash)] [CustomComboInfo("原初的勇猛", "在同步到76级以下时，将原初的勇猛替换为原初的直觉.", WAR.JobID, 0, "", "")]
        WAR_NascentFlash = 18005,

        [ParentCombo(WAR_ST_StormsPath)] [CustomComboInfo("动乱", "在有暴风碎BUFF时，将动乱加入到暴风斩连击", WAR.JobID, 0, "", "")]
        WAR_ST_StormsPath_Upheaval = 18007,

        [ParentCombo(WAR_ST_StormsPath)] [CustomComboInfo("原初激震", "在有原初激震BUFF时，将原初激震加入到暴风斩连击", WAR.JobID, 0, "", "")]
        WAR_ST_StormsPath_原初激震 = 180071,

        [ParentCombo(WAR_ST_StormsPath)] [CustomComboInfo("蛮荒崩裂", "在蛮荒崩裂预备状态下，将裂石飞环/地毁人亡替换为蛮荒崩裂(也加入AOE连击)", WAR.JobID, 0, "", "")]
        WAR_ST_StormsPath_PrimalRend = 18008,

        [ParentCombo(WAR_ST_StormsPath)] [CustomComboInfo("破坏斧", "在破坏斧状态下，将破坏斧入到暴风斩连击", WAR.JobID, 0, "", "")]
        WAR_ST_StormsPath_破坏斧 = 180081,

        [ParentCombo(WAR_AoE_Overpower)] [CustomComboInfo("群山隆起", "在有暴风碎BUFF时，将群山隆起加入到AOE连击", WAR.JobID, 0, "", "")]
        ...
        [ParentCombo(WAR_ST_StormsPath)] [CustomComboInfo("猛攻", "在有暴风碎BUFF时，将猛攻加入到暴风斩连击", WAR.JobID, 0, "", "")]
        WAR_ST_StormsPath_Onslaught = 18012,

        [ParentCombo(WAR_AoE_Overpower)] [CustomComboInfo("战嚎 AoE", "在兽魂不低于50的时候将战壕加入AOE连击.", WAR.JobID, 0, "", "")]
        WAR_AoE_Overpower_Infuriate = 18013,

        [ParentCombo(WAR_AoE_Overpower)] [CustomComboInfo("原初的解放 AoE", "将原初的解放加入到暴风斩连击", WAR.JobID, 0, "", "")]
        WAR_AoE_Overpower_InnerRelease = 18014,

        [ParentCombo(WAR_ST_StormsPath)] [CustomComboInfo("飞斧", "在如果离boss太远，将飞斧加入到暴风斩连击.", WAR.JobID, 0, "", "")]
        WAR_ST_StormsPath_RangedUptime = 18016,


        [ReplaceSkill(WAR.裂石飞环FellCleave, WAR.Decimate)] [CustomComboInfo("战壕与裂石飞环/地毁人亡整合", "小于等于设置距离时，将裂石飞环/地毁人亡整合到战壕", WAR.JobID, 0, "", "")]
        WAR_InfuriateFellCleave = 18018,

        [ReplaceSkill(WAR.原初的解放InnerRelease)] [CustomComboInfo("蛮荒崩裂Main combo", "在蛮荒崩裂预备状态下，将原初的解放替换为蛮荒崩裂.", WAR.JobID, 0, "", "")]
        WAR_PrimalRend_InnerRelease = 18019,

        [ParentCombo(WAR_ST_StormsPath)] [CustomComboInfo("原初的解放加入暴风斩循环", "将原初的解放加入到暴风斩连击", WAR.JobID, 0, "", "")]
        WAR_ST_StormsPath_InnerRelease = 18020,

        [ParentCombo(WAR_ST_StormsPath)] [CustomComboInfo("战壕加入暴风斩循环", "在兽魂不低于50的时候将战壕加入暴风斩连击.", WAR.JobID, 0, "", "")]
        WAR_ST_StormsPath_Infuriate = 18021,

        [ParentCombo(WAR_InfuriateFellCleave)] [CustomComboInfo("原初的解放 优先选项", "当 原初的解放 可用时，不使用 战嚎。", WAR.JobID, 0, "", "")]
        ...
        [ParentCombo(WAR_ST_StormsPath_Onslaught)] [CustomComboInfo("猛攻", "在 战场风暴 状态下以及在目标环（1m）内并且不移动时使用 猛攻。 \n将使用上面滑块中选择的层数。", WAR.JobID, 0, "", "")]
        WAR_ST_StormsPath_Onslaught_MeleeSpender = 18024,

        [Variant] [VariantParent(WAR_ST_StormsPath, WAR_AoE_Overpower)] [CustomComboInfo("精神镖选项", "当没有dot或dot剩余时间少于3s时，使用多变精神镖", WAR.JobID)]
        WAR_Variant_SpiritDart = 18025,

        [Variant] [VariantParent(WAR_ST_StormsPath, WAR_AoE_Overpower)] [CustomComboInfo("治疗 选项", "在下水道使用治疗当HP低于某个值", WAR.JobID)]
        WAR_Variant_Cure = 18026,

        [Variant] [VariantParent(WAR_ST_StormsPath, WAR_AoE_Overpower)] [CustomComboInfo("最后通牒 选项", "冷却结束时使用多变最后通牒", WAR.JobID)]
        ...
        [ParentCombo(WHM_AoE_DPS)] [CustomComboInfo("Assize Option", "Adds Assize to the AoE combo.", WHM.JobID, 21, "", "")]
        ...
        [ParentCombo(WHM_AoE_DPS)]
        [CustomComboInfo("Presence of Mind Option", "Adds Presence of Mind to the AoE combo if you are moving or it can be weaved without GCD delay.",
            WHM.JobID, 24, "", "")]
        ...
        [ParentCombo(WHM_AoEHeals)] [CustomComboInfo("Afflatus Rapture Option", "Uses Afflatus Rapture when available.", WHM.JobID, 61, "", "")]
        WHM_AoEHeals_Rapture = 19011,

        [ParentCombo(WHM_AoEHeals)] [CustomComboInfo("Afflatus Misery Option", "Uses Afflatus Misery when available.", WHM.JobID, 62, "", "")]
        WHM_AoEHeals_Misery = 19010,

        [ParentCombo(WHM_AoEHeals)] [CustomComboInfo("Thin Air Option", "Uses Thin Air when available.", WHM.JobID, 63, "", "")]
        WHM_AoeHeals_ThinAir = 19200,

        [ParentCombo(WHM_AoEHeals)] [CustomComboInfo("Cure III Option", "Replaces Medica with Cure III when available.", WHM.JobID)]
        ...
        [ParentCombo(WHM_AoEHeals)] [CustomComboInfo("Plenary Indulgence Option", "Uses Plenary Indulgence when available.", WHM.JobID)]
        WHM_AoEHeals_Plenary = 19203,

        [ParentCombo(WHM_AoEHeals)] [CustomComboInfo("Lucid Dreaming Option", "Uses Lucid Dreaming when available.", WHM.JobID)]
        ...
        [ParentCombo(WHM_STHeals)] [CustomComboInfo("Benediction Option", "Uses Benediction when target is below HP threshold.", WHM.JobID)]
        WHM_STHeals_Benediction = 19302,

        [ParentCombo(WHM_STHeals)] [CustomComboInfo("Afflatus Solace Option", "Uses Afflatus Solace when available.", WHM.JobID)]
        ...
        [ParentCombo(WHM_STHeals)] [CustomComboInfo("Tetragrammaton Option", "Uses Tetragrammaton when available.", WHM.JobID)]
        WHM_STHeals_Tetragrammaton = 19305,

        [ParentCombo(WHM_STHeals)] [CustomComboInfo("Divine Benison Option", "Uses Divine Benison when available.", WHM.JobID)]
        WHM_STHeals_Benison = 19306,

        [ParentCombo(WHM_STHeals)] [CustomComboInfo("Aqualveil Option", "Uses Aquaveil when available.", WHM.JobID)]
        WHM_STHeals_Aquaveil = 19307,

        [ParentCombo(WHM_STHeals)] [CustomComboInfo("Lucid Dreaming Option", "Uses Lucid Dreaming when available.", WHM.JobID)]
        WHM_STHeals_Lucid = 19308,

        [ParentCombo(WHM_STHeals)] [CustomComboInfo("Esuna Option", "Applies Esuna to your target if there is a cleansable debuff.", WHM.JobID)]
        ...
        [Variant] [VariantParent(WHM_ST_MainCombo, WHM_AoE_DPS)] [CustomComboInfo("Rampart Option", "Use Variant Rampart on cooldown.", WHM.JobID)]
        ...
        [ReplaceSkill(DOL.AgelessWords, DOL.SolidReason)] [CustomComboInfo("理智同兴", "当理智同兴可用时，将农夫之智或石工之理替换为理智同兴", DOL.JobID)]
        DOL_Eureka = 51001,
        ...
        [ReplaceSkill(DOL.Cast)] [CustomComboInfo("抛竿", "正在钓鱼时，将抛竿替换为提钩", DOL.JobID)]
        FSH_CastHook = 51002,

        [CustomComboInfo("[捕鱼人] 水下 选项", "在水下时用水下能力取代捕鱼能力", DOL.JobID)]
        FSH_Swim = 51008,

        [ReplaceSkill(DOL.Cast)] [ParentCombo(FSH_Swim)] [CustomComboInfo("[捕鱼人] 抛竿 替换 刺鱼", "在水下时将 抛竿 替换为 刺鱼", DOL.JobID)]
        FSH_CastGig = 51003,

        [ReplaceSkill(DOL.SurfaceSlap)] [ParentCombo(FSH_Swim)] [CustomComboInfo("拍击水面 替换 熟能生巧", "在水下时将 拍击水面 替换为 熟能生巧", DOL.JobID)]
        FSH_SurfaceTrade = 51004,

        [ReplaceSkill(DOL.PrizeCatch)] [ParentCombo(FSH_Swim)] [CustomComboInfo("大鱼猎手 替换 嘉惠", "在水下时将 大鱼猎手 替换为 嘉惠", DOL.JobID)]
        FSH_PrizeBounty = 51005,

        [ReplaceSkill(DOL.Snagging)] [ParentCombo(FSH_Swim)] [CustomComboInfo("钓组 替换 打捞", "在水下时将 钓组 替换为 打捞", DOL.JobID)]
        FSH_SnaggingSalvage = 51006,

        [ReplaceSkill(DOL.CastLight)] [ParentCombo(FSH_Swim)] [CustomComboInfo("垂钓之光 替换 电水流", "在水下时将 垂钓之光 替换为 电水流", DOL.JobID)]
        FSH_CastLight_ElectricCurrent = 51007,

        [ReplaceSkill(DOL.Mooch, DOL.MoochII)] [ParentCombo(FSH_Swim)] [CustomComboInfo("以小钓大 替换 鲨鱼之眼", "在水下时将 以小钓大 替换为 鲨鱼之眼", DOL.JobID)]
        FSH_Mooch_SharkEye = 51009,

        [ReplaceSkill(DOL.FishEyes)] [ParentCombo(FSH_Swim)] [CustomComboInfo("鱼眼 替换 聚精鱼眼", "在水下时将 鱼眼 替换为 聚精鱼眼", DOL.JobID)]
        FSH_FishEyes_VitalSight = 51010,

        [ReplaceSkill(DOL.Chum)] [ParentCombo(FSH_Swim)] [CustomComboInfo("撒饵 替换 闭气", "在水下时将 撒饵 替换为 闭气", DOL.JobID)]
        ...
        [ParentCombo(DRGPvP_Burst)] [CustomComboInfo("天龙点睛选项", "Adds Wyrmwind Thrust to Burst Mode.", DRG.JobID)]
        ...
        [ParentCombo(GNBPvP_Burst)] [CustomComboInfo("Gnashing Fang Option", "Adds Gnashing Fang to 爆发模式 while under the No Mercy buff.", GNB.JobID)]
        ...
        [ParentCombo(GNBPvP_Burst)] [CustomComboInfo("粗分斩设置", "Weaves Rough Divide when No Mercy Buff is about to expire.", GNB.JobID)]
        GNBPvP_RoughDivide = 117006,

        [ParentCombo(GNBPvP_Burst)] [CustomComboInfo("Junction Cast DPS Option", "Adds Junction Cast (DPS) to Burst Mode.", GNB.JobID)]
        GNBPvP_JunctionDPS = 117007,

        [ParentCombo(GNBPvP_Burst)] [CustomComboInfo("Junction Cast Healer Option", "Adds Junction Cast (Healer) to Burst Mode.", GNB.JobID)]
        GNBPvP_JunctionHealer = 117008,

        [ParentCombo(GNBPvP_Burst)] [CustomComboInfo("Junction Cast Tank Option", "Adds Junction Cast (Tank) to Burst Mode.", GNB.JobID)]
        ...
        [ParentCombo(SCHPvP_Burst)] [CustomComboInfo("Biolysis Option", "Adds Biolysis use on cooldown to Burst Mode.", SCH.JobID)]
        SCHPvP_Biolysis = 126002,

        [ParentCombo(SCHPvP_Burst)] [CustomComboInfo("Deployment Tactics Option", "Adds Deployment Tactics to 爆发模式 when available.", SCH.JobID)]
        ...
        [ParentCombo(WHMPvP_Burst)] [CustomComboInfo("Miracle of Nature Option", "Adds Miracle of Nature to Burst Mode.", WHM.JobID)]
