...
public class Translatezh_CN
{
    public static Dictionary<string, string> db = new()
    {
        ...
        {"Burst Shot/Quick Nock to Apex Arrow Feature","等待翻译"},
        ...
        {"Replaces Quick Nock/Ladonsbite with Shadowbite when ready.","等待翻译"},
        {"Simple Bard Feature","简易诗人"},
        {"Adds every single target ability to one button,\nIf there are DoTs on target, Simple Bard will try to maintain their uptime.",
        "将每个单目标能力技整合到一个按键,\n如果目标身上有DoTs,会试图保持它们的刷新时间."},
        {"Simple Bard DoTs Option","简易诗人Dots"},
        {"This option will make Simple Bard apply DoTs if none are present on the target.","如果目标身上不存在风/毒dot，开启此选项会在连击中加入风/毒箭。"},
        {"Simple Bard Songs Option","简易诗人唱歌"},
        {"This option adds the Bard's Songs to the Simple Bard Feature.","这个选项将诗人的三首歌加入简易诗人功能里"},
        {"Songs Feature","唱歌相关设置"},
        ...
        {"Add Mage's Ballad and Army's Paeon to Wanderer's Minuet depending on cooldowns.","根据CD，将另外两首歌加入放浪神的小步舞曲."},
        {"Simple AoE Bard Feature","简易诗人(AOE)"},
        {"Weaves oGCDs onto Quick Nock/Ladonsbite.","等待翻译"},
        {"Simple AoE Bard Song Option","简易诗人唱歌(AOE)"},
        {"Weave Songs on the Simple AoE.","等待翻译"},
        {"Simple Buffs Option","简易诗人Buffs"},
        {"Adds buffs onto the Simple Bard feature.","自动插入Buff技能。"},
        {"Simple Buffs - Radiant Option","光明神的最终乐章替换设置"},
        {"Adds Radiant Finale to the Simple Buffs feature.","当可用时自动插入光明神的最终乐章。"},
        {"Simple No Waste Option","防止资源浪费相关选项"},
        ...
        {"Uses interrupt during the rotation if applicable.","如果可用，在循环中加入打断技能"},
        {"Disable Apex Arrow Feature","禁用绝峰箭"},
        ...
        {"Exclude Wanderer's Minuet Option","除外放浪神的小步舞曲"},
        {"Dont use Wanderer's Minuet.","不使用放浪神的小步舞曲"},
        {"Second Wind Option","内丹选项"},
        {"Uses Second Wind when below set HP percentage.","当低于此生命值百分比时，使用内丹"},
        #endregion
        #region DANCER
        ...
        {"Standard And Technical Dance on one button (SS).","整合标准与技巧舞步到一键 (SS)"},
        ...
        {"Features and options involving Fourfold Feathers and Flourish.","百花争艳与幻扇相关设置.\n折叠此选项不会禁用里面的功能."},
        ...
        {"Options for Fan Dance combos.","扇舞连击相关选项"},
        ...
        {"Change Standard Step and Technical Step into each dance step, while dancing.","跳舞时将标准舞步和技巧舞步替换成每一个步的舞步"},
        ...
        "单目标一键. 包含唱，跳，rap，篮球（百花争艳，与量谱溢出保护）.\n与几乎所有不带简易字样的选项冲突，除了‘舞步连击’."},
        ...
        "双目标一键. 包含唱，跳，rap，篮球（百花争艳，与量谱溢出保护）.\n与几乎所有不带简易字样的选项冲突，除了‘舞步连击’." },
        {"Simple Standard Fill Option","简易标准舞步选项"},
        {"Adds ONLY Standard dance steps and Standard Finish to the rotation.","只加入标准舞步和其结束进循环."},
        ...
        {"Adds ONLY Technical dance steps and Technical Finish to the rotation.","只加入技巧舞步和其结束进循环."},
        {"Simple Tech Devilment Option","简易技巧进攻之探戈"},
        {"Includes Devilment in the rotation.","将进攻之探戈加入循环."},
        {"Simple Saber Dance Option","简易扇舞选项"},
        {"Includes Saber Dance in the rotation when at or over the Esprit threshold.","将剑舞加入循环当伶俐超过临界点"},
        ...
        "当脱战时使用速行，不会一直保持速行buff存在，并且在跳舞剩余时间少于5秒后释放舞蹈.（存疑）"},
        #endregion
        ...
        {"Simple AoE Saber Dance Option","等待翻译"},
        {"Includes Saber Dance in the AoE rotation when at or over the Esprit threshold.","等待翻译"},
        ...
        {"Ultimatum Option","等待翻译"},
        {"Use Variant Ultimatum on cooldown.","等待翻译"},
        #endregion
        #region DRAGOON
        ...
        {"Replaces True Thrust with the entire ST combo chain.","等待翻译"},
        {"Level 88+ Opener","88级起手"},
        {"Adds opener to the rotation.\nActivates when Battle Litany and Lance Charge are off cooldown and when True North is used outside of combat or if Elusive Jump is used at the beginning of battle. OPTIONAL: USE REACTION OR MOACTION FOR OPTIMAL TARGETING.","等待翻译"},
        ...
        {"Adds Bloodbath and Second Wind to the combo, using them when below the HP Percentage threshold.","等待翻译"},
        #endregion
        ...
        #endregion
        #region GUNBREAKER
        {"Skill Speed Support Feature","技能速度"},
        {"Allows for features to support various skill speed rotations.","支持不同的技能速度"},
        #region ST
        {"Advanced Gunbreaker Feature","绝枪战士一键连击"},
        {"Replace Keen Edge with its combo chain and uses Burst Strike to prevent ammo overcap.","替换利刃斩和爆发击防止子弹溢出"},
        #region Gnashing Fang
        {"Gnashing Fang and Continuation on Main Combo Option","烈牙与续剑整合到主连击"},
        {"Adds Gnashing Fang to the main combo. Gnashing Fang must be started manually and the combo will finish it off.","将烈牙与续剑整合到主连击。烈牙必须被手动激活，之后会被替换到主连击。"},
        {"Gnashing Fang Starter Option","烈牙启动"},
        {"Begins Gnashing Fang to the main combo.","先从烈牙开始倾泻晶壤."},
        #endregion
        #region Cooldowns
        {"Cooldowns on Main Combo Option","暗黑骑士能力技整合 设置"},
        {"GNB_ST_Cooldowns on Main Combo Option","绝枪战士能力技整合 设置"},
        {"Adds various cooldowns to the main combo when under No Mercy or when No Mercy is on cooldown.","选择是否在无情状态下将各种能力技整合至主连击中"},
        {"Double Down on Main Combo Option","倍攻整合到主连击"},
        {"Adds Double Down to the main combo when under No Mercy buff.","在无情状态下才在主连击中插入倍攻"},
        {"Danger Zone/Blasting Zone on Main Combo Option","危险领域/爆破领域整合到主连击"},
        {"Adds Danger Zone/Blasting Zone to the main combo.","添加危险领域/爆破领域整合到主连击"},
        {"Bloodfest on Main Combo Option","血壤整合到主连击"},
        {"Adds Bloodfest to the main combo when ammo is 0.","当晶壤为0时在主连击中插入血壤."},
        {"No Mercy on Main Combo Option","无情整合到主连击"},
        {"Adds No Mercy to the main combo when at full ammo.","当晶壤积累满时在主连击中插入无情."},
        {"Bow Shock on Main Combo Option","弓形冲波整合到主连击"},
        {"Adds Bow Shock to the main combo.","弓形冲波整合到主连击"},
        {"Sonic Break on Main Combo Option","音速破整合到主连击"},
        {"Adds Sonic Break to the main combo.","在主连击中插入音速破."},
        {"Burst Strike on Main Combo Option","爆发击整合到主连击"},
        ...
        {"Uses Rough Divide when under No Mercy, burst cooldowns when available, not moving, and in the target ring (1 yalm).\nWill use as many stacks as selected in the above slider.","在目标换里面插入粗分斩"},
        #endregion
        {"Lightning Shot Uptime Option","闪雷弹激活"},
        {"Adds Lightning Shot to the main combo when you are out of range.","当自身与所选目标在近战距离外时，插入闪雷弹."},
        #endregion
        #region Gnashing Fang
        {"Gnashing Fang Continuation Combo Feature","等待翻译"},
        {"Adds Continuation to Gnashing Fang.","将续剑添加到烈牙."},
        {"No Mercy on Gnashing Fang Option","无情整合到烈牙"},
        {"Adds No Mercy to Gnashing Fang when it's ready.","当无情冷却结束时将其整合到烈牙."},
        {"Double Down on Gnashing Fang Option","倍攻整合到烈牙"},
        {"Adds Double Down to Gnashing Fang when No Mercy buff is up.","当拥有无情BUFF时将倍攻整合到烈牙"},
        {"Cooldowns on Gnashing Fang Option","等待翻译"},
        {"Adds Bloodfest/Sonic Break/Bow Shock/Blasting Zone on Gnashing Fang, order dependent on No Mercy buff.\nBurst Strike and Hypervelocity added if there's charges while No Mercy buff is up.","在烈牙上添加爆发击/音速破/弓形冲波/爆破领域，顺序取决于无情buff。\n如果在没有无情buff的情况下有子弹，则为爆发击和超速度。"},
        #endregion
        #region AoE
        {"Advanced Gunbreaker AoE Feature","绝枪战士AOE功能"},
        {"Replace Demon Slice with its combo chain.","将恶魔杀替换为恶魔杀连击。"},
        {"No Mercy AoE Option","无情整合至AoE连击"},
        {"Adds No Mercy to the AoE combo when it's available.","当无情可用时在AoE连击中插入无情."},
        {"Bow Shock on AoE Option","弓形冲波整合到AOE连击"},
        {"Adds Bow Shock onto the AoE combo when it's off cooldown.","当可用时在AoE连击中插入弓形冲波."},
        {"Bloodfest AoE Option","血壤整合至AoE连击"},
        {"Adds Bloodfest to the AoE combo when it's available. Will dump Ammo through Fated Circle to prepare for Bloodfest.","当可用时在AoE连击中插入血壤.会先使用命运之环以确保使用血壤不会使晶壤溢出."},
        {"Double Down AoE Option","倍攻整合至AoE连击"},
        {"Adds Double Down to the AoE combo when it's available and there is 2 or more ammo.","当倍攻可用且晶壤有2个以上时在AoE连击中插入倍攻."},
        {"Danger Zone on AoE Option","等待翻译"},
        {"Adds Danger Zone to the AoE combo when it's off cooldown.","当可用时在AoE连击中插入危险领域."},
        {"Sonic Break on AoE Option","等待翻译"},
        {"Adds Sonic Break to the AoE combo when it's off cooldown.","当可用时在AoE连击中插入音速破."},
        {"Ammo Overcap Option","晶壤溢出特性"},
        {"Adds Fated Circle to the AoE combo when about to overcap.","当晶壤将要溢出时使用命运之环替换掉AOE连击。"},
        #endregion
        #region Burst Strike
        {"Burst Strike Features","爆发击 Feature"},
        {"Collection of Burst Strike related features.","爆发击 相关功能"},
        {"Burst Strike Continuation Feature","爆发击续剑"},
        ...
        #endregion
        #region No Mercy
        {"Cooldowns on No Mercy Feature","无情"},
        {"Adds Cooldowns to No Mercy when No Mercy is on cooldown.","无情冷却替换无情"},
        {"Double Down Option","倍攻"},
        {"Adds Double Down to No Mercy when No Mercy is on cooldown.","无情状态下，用倍攻代替无情"},
        {"Sonic Break/Bow Shock Option","音速破/弓形冲波"},
        {"Adds Sonic Break and Bow Shock to No Mercy when No Mercy is on cooldown.","无情状态下，用音速破/弓形冲波代替无情"},
        #endregion
        ...
        {"Drill/Air Anchor (Hot Shot) Feature","等待翻译"},
        ...
        {"Drill/Air/Chain Saw on Main Combo Option","钻头/空气锚/回转飞锯整合 设置"},
        ...
        {"Switches Auto Crossbow to Hypercharge and weaves Gauss Round/Ricochet.","等待翻译"},
        {"Alternate Drill/Air Feature on Main Combo Option","交替插入钻头/空气锚/热弹被添加到连击循环中"},
        ...
        {"Single Button Heat Blast on Main Combo Option","等待翻译"},
        {"Adds Single Button Heat Blast onto the main combo when the option is enabled.","等待翻译"},
        {"Battery Overcap Option","电量溢出后自动替换炮台/人偶"},
        {"Overcharge protection for your Battery, If you are at 100 battery charge Rook Autoturret/Automaton Queen will be added to your (Heated) Shot Combo.","等待翻译"},
        {"Adds overcharge protection to Spread Shot/Scattergun.","为散射/霰弹枪增加了过电量保护。."},
        {"Gauss Round Ricochet Option","虹吸弹/弹射整合 设置"},
        {"Adds Gauss Round/Ricochet to the AoE combo during Hypercharge.","在超荷过程中为AOE连击循环增加虹吸弹/弹射"},
        {"Always Gauss Round/Ricochet Option","不限制虹吸弹/弹射的插入时机"},
        {"Adds Gauss Round/Ricochet to the AoE combo outside of Hypercharge windows.","在超荷窗口之外的AOE连击循环中也会插入可用的虹吸弹/弹射."},
        {"Ricochet & Gauss Round Option","弹射 & 虹吸弹 设置"},
        {"Adds Ricochet and Gauss Round to main combo.\nWill use all charges.","将弹射和虹吸弹添加到主连击循环中.这将使用所有电能."},
        {"Ricochet & Gauss Round overcap protection option","弹射 & 虹吸弹防溢出 设置"},
        {"Adds Ricochet and Gauss Round to main combo.\nWill leave 1 charge of each.","将弹射和虹吸弹添加到主连击循环中.将各留下一个电能."},
        {"Barrel Stabilizer Drift Protection Option","枪管加热避免延后浪费 设置"},
        {"Adds Barrel Stabilizer onto the main combo if Heat Gauge is between 5-20.","如果热量在5-20之间，则将枪管加热添加到主连击循环中。"},
        {"Wildfire Option","野火 设置"},
        {"Adds Wildfire to the Single Button Heat Blast Feature if Wildfire is off cooldown and you have enough Heat Gauge for Hypercharge then Hypercharge will be replaced with Wildfire.\nAlso weaves Ricochet/Gauss Round on Heat Blast when necessary.","等待翻译"},
        {"BioBlaster Option","毒菌冲击整合 设置"},
        {"Adds Bioblaster to the Spreadshot feature","在散射的功能中添加毒菌冲击"},
        {"Barrel Feature","枪管加热 设置"},
        {"Adds Barrel Stabilizer to Single Button Heat Blast and Single Button Auto Crossbow Features when below 50 Heat Gauge and it is off cooldown","等待翻译"},
        {"Simple Machinist Feature","一键简单机工循环"},
        ...
        {"Uses interrupt during the rotation, if applicable.","等待翻译"},
        {"Simple Gadget Option","简单的机工召唤"},
        {"Adds Automaton Queen or Rook Autoturret uses to the feature, based on your current level.\nAttempts to use Automaton Queen at optimal intervals between :55 to :05 windows.","等待翻译"},
        {"Simple Assembling Option","简单的组装"},
        {"Pairs reassemble uses with the following skills.\nBefore acquiring Drill it will be used with Clean Shot.","整备将与下面的技能一起使用.\n在获得钻头之前，它将使用与狙击弹共用."},
        {"Simple Gauss Ricochet Option","简单的虹吸弹和弹射"},
        {"Adds Gauss Round and Ricochet uses to the feature.","将虹吸弹和弹射加入到循环中."},
        {"Simple Wildcharge Option","简单的野火和超荷"},
        {"Adds Hypercharge and Wildfire uses to the feature.\nIt respects the 8 second rule of Drill, Air Anchor and Chain Saw.","等待翻译"},
        {"Simple Stabilizer Option","枪管加热"},
        {"Adds Barrel Stabilizer to the feature.\nWhen Heat Gauge < 50 and Wildfire is off cooldown or about to come off cooldown.","等待翻译"},
        {"Hypercharge Option","超荷"},
        {"Adds hypercharge to the AoE.","将超荷加入到AOE循环中."},
        {"Simple Machinist AoE Feature","机工简易AoE一键连击"},
        {"Spread Shot turns into Scattergun when Lv.82 or higher.\nBoth turn into Auto Crossbow when Overheated.\nBioblaster is used first whenever it is off cooldown.","等待翻译"},
        {"Drill Option","钻头"},
        ...
        {"Only use Drill Option","只使用钻头"},
        {"Only use Drill when you have max charges of Reassemble.","等待翻译"},
        {"Only use Air Anchor Option","只使用空气锚"},
        {"Only use Air Anchor when you have max charges of Reassemble.","等待翻译"},
        {"Only use Chain Saw Option","只使用回转飞锯"},
        {"Only use Chain Saw when you have max charges of Reassemble.","等待翻译"},
        {"Wildfire Only Option","在特定时机插入"},
        {"Only use it to prepare for Wildfire use.","仅为野火使用枪管加热."},
        {"High Ping Mode Option","高延迟模式"},
        {"A high-ping-friendly mode.\nIt limits the uses of Gauss Round/Ricochet inside Hypercharge windows to prevent drift.\nExpect a small DPS loss when using this feature.","等待翻译"},
        {"Use Second Wind when below the set HP percentage.","等待翻译"},
        #endregion
        #region MONK
        ...
        {"Delayed Trick Attack Option","延后 攻其不备"},
        {"Waits at least 8 seconds into combat before using Trick Attack.","进入战斗至少8s后再使用 攻其不备"},
        {"Ninjitsu Option","忍术 选项"},
        {"Adds Ninjitsu to Advanced Mode.","将 忍术 加入上忍循环"},
        {"Hold 1 Charge","保留1层充能"},
        ...
        {"Ten Chi Jin to Meisui Feature","命水 替换 天地人"},
        ...
        {"Hide to Mug/Trick Attack Feature","等待翻译"},
        ...
        {"Huraijin / Armor Crush Combo Feature","风来刃/强点破甲突"},
        {"Replace Huraijin with Armor Crush after using Gust Slash.","使用 绝风 后，用 强甲破点突 替换 风来刃"},
        {"Raiton Uptime Option","等待翻译"},
        {"Adds Raiton as an uptime feature.","等待翻译"},
        {"Phantom Kamaitachi Uptime Option","等待翻译"},
        {"Adds Phantom Kamaitachi as an uptime feature.","等待翻译"},
        {"Suiton Uptime Option","等待翻译"},
        {"Adds Suiton as an uptime feature.","等待翻译"},
        {"Adds True North before Armor Crush when you are not in the correct position for the enhanced potency bonus.","在强点破甲突前面插入一个真北，如果你不在正确的身位上."},
        #endregion
        #region PALADIN
        ...
        {"Adds Gibbet and Gallows to the combo when current target is afflicted with Death's Design.","等待翻译"},
        {"Void/Cross Reaping Option","等待翻译"},
        {"Adds Void Reaping and Cross Reaping to the to the the combo during Enshroud.","等待翻译"},
        ...
        {"Level 90 Opener Option","90级起手选项"},
        {"Adds the Level 90 Opener to the main combo. Choose which Opener to use below.","将90级起手加入主连击，在下面选用哪个起手."},
        #endregion
        ...
        {"Grim Reaping Option","等待翻译"},
        {"Adds Grim Reaping to the to the AoE combo during Enshroud.","等待翻译"},
        ...
        {"Lemure's Scythe Option","等待翻译"},
        {"Adds Lemure's Scythe to the AoE combo when there are 2 Void Shrouds.","等待翻译"},
        ...
        {"Adds various options to Dosis I/II/III.","等待翻译"},
        {"Lucid Dreaming Option","循环加入醒梦"},
        {"Weaves Lucid Dreaming when your MP drops below the specified value.","当MP小于滑块值时，将醒梦整合至此循环"},
        {"Eukrasian Dosis Option","均衡注药 设置"},
        {"Automatic DoT Uptime.","自动插入均衡注药续Dot."},
        {"Movement Options","移动选项"},
        {"Use selected instant cast actions while moving.","移动时使用选择的顺发技能"},
        {"Phlegma Option","发炎 选项"},
        {"Use Phlegma if available and within range.","使用发炎如果它可用并且在距离内"},
        {"Kardia Reminder Option","等待翻译"},
        {"Adds Kardia when not under the effect.","等待翻译"},
        {"Rhizomata Option","根素选项"},
        {"Weaves Rhizomata when Addersgall gauge falls below the specified value.","等待翻译"},
        #endregion
        ...
        {"Weaves Lucid Dreaming when your MP falls below the specified value.","当MP小于滑块值时，将醒梦整合至此循环"},
        #endregion
        ...
        {"Ignore Shield Check","等待翻译"},
        {"Warning, will force the use of Eukrasia Diagnosis, and normal Diagnosis will be unavailable.","等待翻译"},
        {"Soteria Option","拯救选项"},
        ...
        {"Gekko Combo","月光连"},
        {"Replace Gekko with its combo chain.\nIf all sub options are selected will turn into a full one button rotation (Advanced Samurai)",
        "替换 月光 技能为它的连击链.\n如果下面的全部子选项都有相应选择会形成一个一键连击循环 （高级武士）"},
        ...
        {"Adds Yukikaze Combo to main combo. Will add Yukikaze during Meikyo Shisui as well","将雪风连击加入主循环。在明镜止水期间也会加入雪风连击。"},
        {"Kasha Combo on Main Combo","花车连击加入循环"},
        {"Adds Kasha combo to main combo. Will add Kasha during Meikyo Shisui as well.","将花车连击加入主循环。在明镜止水期间也会加入花车连击"},
        {"Level 90 Samurai Opener","90级武士起手爆发"},
        ...
        {"Execute Feature","等待翻译"},
        {"Adds Shinten to the main combo when Kenki > 25 and your current target is below the HP percentage threshold.","当目标血量小于此百分比时，只要有25点剑气就将震天加入循环."},
        #endregion
        #endregion
        ...
        {"Any Searing Burst Option","等待翻译"},
        {"Checks for any Searing light for bursting rather than just your own.\nUse this option if partied with multiple SMN and are worried about your Searing being overwritten.","等待翻译"},
        #endregion
        #region WARRIOR
        {"Storm's Path Combo Feature","暴风斩连击"},
        {"All in one main combo feature, adds Storm's Eye/Path.\nIf all sub-options and Fell Cleave/Decimate Options are toggled, will turn into a full one button rotation (Advanced Warrior).",
        "战士主连击整合，加入暴风斩/碎.\n如果下面的所有子选项和裂石飞环/地毁人亡都被打开并加以设定，会形成一个完整的一键连击（高级战士，有一定智力的战士0.0）"},
        {"Storm's Eye Combo Feature","暴风碎连击"},
        {"Replace Storm's Eye with its combo chain.","将暴风碎替换为暴风碎连击"},
        {"Overpower Combo Feature","超压斧连击"},
        {"Add combos to Overpower.","将超压斧替换为AOE连击"},
        {"Warrior Gauge Overcap Option","兽魂监控"},
        {"Replace Single target or AoE combo with gauge spender if you are about to overcap and are before a step of a combo that would generate Beast gauge.",
        "如果兽魂快溢出了，将消耗兽魂的技能加入到暴风斩连击和AOE连击"},
        ...
        {"Replaces Inner Beast and Steel Cyclone with Primal Rend when available (also added onto main AoE combo).","在蛮荒崩裂预备状态下，将裂石飞环/地毁人亡替换为蛮荒崩裂(也加入AOE连击)"},
        {"Orogeny Option","群山隆起"},
        ...
        {"Infuriate AoE Option","战嚎 AoE"},
        {"Adds Infuriate to AoE combo when gauge is below 50 and not under Inner Release.","在兽魂不低于50的时候将战壕加入AOE连击."},
        {"Inner Release AoE Option","原初的解放 AoE"},
        ...
        {"Infuriate on Fell Cleave / Decimate Feature","战壕与裂石飞环/地毁人亡整合"},
        {"Turns Fell Cleave and Decimate into Infuriate if at or under set rage value.","小于等于设置距离时，将裂石飞环/地毁人亡整合到战壕"},
        {"Primal Rend Feature","蛮荒崩裂Main combo"},
        {"Turns Inner Release into Primal Rend on use.","在蛮荒崩裂预备状态下，将原初的解放替换为蛮荒崩裂."},
        {"Inner Release on Storm's Path Option","原初的解放加入暴风斩循环"},
        {"Infuriate on Storm's Path Option","战壕加入暴风斩循环"},
        {"Adds Infuriate to Storm's Path combo when gauge is below 50 and not under Inner Release.","在兽魂不低于50的时候将战壕加入暴风斩连击."},
        {"Inner Release Priority Option","等待翻译"},
        {"Prevents the use of Infuriate while you have Inner Release stacks available.","等待翻译"},
        {"Primal Rend Melee Option","等待翻译"},
        {"Uses Primal Rend when in the target's target ring (1 yalm) and when not moving otherwise will use it when buff is less than 10 seconds.","等待翻译"},
        {"Melee Onslaught Option","猛攻"},
        {"Uses Onslaught when under Surging Tempest and in the target ring (1 yalm) and when not moving.\nWill use as many stacks as selected in the above slider.","等待翻译"},
        #endregion
        #region WHITE MAGE
        #region Single Target DPS Feature
        {"Collection of cooldowns and spell features on Glare/Stone.","咏唱闪耀/飞石后插入能力技."},
        {"Glare III Opener Option","开场技能整合至闪灼 设置"},
        {"Delays all oGCDs until after third Glare III cast.","将所有的能力技延迟到第三发闪灼释放之后，仅当闪灼可用时生效"},
        ...
        #endregion
        #region DOL
        {"[BTN/MIN] Eureka Feature","理智同兴"},
        {"Replaces Ageless Words and Solid Reason with Wise to the World when available","当理智同兴可用时，将农夫之智或石工之理替换为理智同兴"},
        {"[BTN/MIN] Locate & Truth Feature","等待翻译"},
        {"Replaces Lay of the Lands or Arbor Calls with Prospect/Triangulate and Truth of Mountains/Forests if not active.","等待翻译"},
        {"[FSH] Cast to Hook Feature","抛竿"},
        {"Replaces Cast with Hook when fishing","正在钓鱼时，将抛竿替换为提钩"},
        {"[FSH] Diving Feature","等待翻译"},
        {"Replace fishing abilities with diving abilities when underwater","等待翻译"},
        {"[FSH] Cast to Gig Option","等待翻译"},
        {"Replaces Cast with Gig when diving.","等待翻译"},
        {"Surface Slap to Veteran Trade Option","等待翻译"},
        {"Replaces Surface Slap with Veteran Trade when diving.","等待翻译"},
        {"Prize Catch to Nature's Bounty Option","等待翻译"},
        {"Replaces Prize Catch with Nature's Bounty when diving.","等待翻译"},
        {"Snagging to Salvage Option","等待翻译"},
        {"Replaces Snagging with Salvage when diving.","等待翻译"},
        {"Cast Light to Electric Current Option","等待翻译"},
        {"Replaces Cast Light with Electric Current when diving.","等待翻译"},
        {"Mooch to Shark Eye Option","等待翻译"},
        {"Replaces Mooch with Shark Eye when diving.","等待翻译"},
        {"Fish Eyes to Vital Sight Option","等待翻译"},
        {"Replaces Fish Eyes with Vital Sight when diving.","等待翻译"},
        {"Chum to Baited Breath Option","等待翻译"},
        {"Replaces Chum with Baited Breath when diving.","等待翻译"},
        #endregion
        #endregion
        #region PvP Combos
        #region ASTROLOGIAN
        ...
        {"No Frazzle Option","等待翻译"},
        {"Prevents Frazzle being used in Burst Mode.","等待翻译"},
        #endregion
        #region WARRIOR
        ...
        #endregion
        #region DARK KNIGHT
        {"Turns Souleater Combo into an all-in-one damage button.","等待翻译"},
        {"Adds Plunge to Burst Mode","等待翻译"},
        {"Use in Melee","等待翻译"},
        {"Uses Plunge whilst in melee aswell as to gap close.","等待翻译"},
        #endregion
        #region DRAGOON
        #endregion
        #region GUNBREAKER
